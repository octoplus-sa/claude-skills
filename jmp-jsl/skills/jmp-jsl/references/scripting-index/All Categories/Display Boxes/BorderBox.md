...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/BorderBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/BorderBox.html)*

---

# [BorderBox](#borderbox)[](#borderbox "Click to copy url")
...
**Description:** Returns a display box that has a border around the display boxes within it.
...
**Syntax:** obj \<\< Bottom( pixels )

**Description:** Adds space between the bottom of the border box and the contents of the border box.

``` jsl
New Window( "Example", bb = Border Box( Text Box( "Hello World!" ) ) );
bb << bottom( 100 );
```
...
**Description:** Returns 0 if background fill is off or 1 if background fill is on.

``` jsl
New Window( "Example",
    bb = Border Box( Left( 10 ), Right( 10 ), Top( 10 ), Bottom( 10 ), Sides( 15 ),
        Text Box( "Hello World!" )
    )
);
Wait( .5 );
bb << SetBackgroundColor( "Red" );/*setting the color forces Fill to be on*/before = bb <<
GetBackgroundFill();
Wait( .5 );
bb << SetBackgroundFill( 0 );
after = bb << GetBackgroundFill();
"before=" || Char( before ) || "  after=" || Char( after );
```
...
**Description:** Returns the number code for the line style of the border.
...
### [GetBottom](#getbottom)[](#getbottom "Click to copy url")

**Syntax:** pixels = obj \<\< GetBottom

**Description:** returns the bottom border
...
### [GetLeft](#getleft)[](#getleft "Click to copy url")

**Syntax:** pixels = obj \<\< GetLeft

**Description:** returns the left border
...
### [GetRight](#getright)[](#getright "Click to copy url")

**Syntax:** pixels = obj \<\< GetRight

**Description:** returns the right border
...
### [GetSides](#getsides)[](#getsides "Click to copy url")

**Syntax:** value = obj \<\< GetSides

**Description:** returns which sides are drawn
...
### [GetTop](#gettop)[](#gettop "Click to copy url")

**Syntax:** pixels = obj \<\< GetTop

**Description:** returns the top border
...
**Syntax:** obj \<\< Left( pixels )

**Description:** Adds space between the left of the border box and the contents of the border box.
...
**Syntax:** obj \<\< Right( pixels )

**Description:** Adds space between the right of the border box and the contents of the border box.
...
**Description:** Enables or disables filling the background of the border box with the background color.
...
Wait( 1 );
bb << SetBackgroundColor( "Red" );/*setting the color forces Fill to be on*/Wait( 1 );
bb << SetBackgroundFill( 0 );
```

### [Set Style](#set-style)[](#set-style "Click to copy url")

**Syntax:** obj \<\< Set Style( pen style )

**Description:** Sets the line style for the border. Pen style can be either the number or the quoted string: 0 (Solid), 1 (Dotted), 2 (Dashed), 3 (DashDot), 4 (DashDotDot)
...
**Syntax:** obj \<\< Sides( value )

**Description:** An integer that maps to settings for the display box.
...
**Syntax:** obj \<\< Top( pixels )

**Description:** Adds space between the top of the border box and the contents of the border box.
...
[ Previous](BarSeg.html "BarSeg") [Next ](BoxPlotSeg.html "BoxPlotSeg")

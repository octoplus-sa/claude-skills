...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/BusyLightBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/BusyLightBox.html)*

---

# [BusyLightBox](#busylightbox)[](#busylightbox "Click to copy url")
...
``` jsl
New Window( "Example", blb = Busy Light( <<Automatic( 1 ) ) );
```

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Advance](#advance)[](#advance "Click to copy url")

**Syntax:** obj \<\< Advance

**Description:** Moves the busy light ahead.

``` jsl
New Window( "Example", blb = Busy Light() );
For( i = 1, i <= 5, i++,
    Wait( 1 );
    blb << Advance;
);
...
### [Automatic](#automatic)[](#automatic "Click to copy url")

**Syntax:** obj \<\< Automatic

**Description:** Causes the busy light box to spin.
...
**Description:** Disables and hides the busy light box. Automatic must be turned off for Disable to work. Turning Automatic on, or sending the box an Advance message re-enables and displays the busy light box.
...
### [RPM](#rpm)[](#rpm "Click to copy url")

**Syntax:** obj \<\< RPM

**Description:** Sets the speed that the busy light box moves when Automatic is turned on.
...
**Description:** Sets the size of the busy light box in pixels.
...
[ Previous](BoxPlotSeg.html "BoxPlotSeg") [Next ](ButtonBox.html "ButtonBox")

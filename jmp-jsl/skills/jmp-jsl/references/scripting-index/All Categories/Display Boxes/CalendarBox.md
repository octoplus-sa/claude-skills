...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/CalendarBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/CalendarBox.html)*

---

# [CalendarBox](#calendarbox)[](#calendarbox "Click to copy url")
...
**Syntax:** obj \<\< Date( number ); number = obj \<\< Get Date

**Description:** The current selected date in the calendar.

``` jsl
New Window( "Calendar Box Example", cal = Calendar Box() );
Wait( 1 );
cal << Date( Date MDY( 10, 5, 1989 ) );
Show( Abbrev Date( cal << Get Date ) );
```
...
### [Get Date](#get-date)[](#get-date "Click to copy url")
...
### [Get Max Date](#get-max-date)[](#get-max-date "Click to copy url")

**Syntax:** obj \<\< Max Date( number ); number = obj \<\< Get Max Date

**Description:** Set the maximum date. The calendar control will be limited to selections in the correct range.

``` jsl
New Window( "Calendar Box Example", cal = Calendar Box() );
Wait( 1 );
cal << Date( Date MDY( 10, 5, 1989 ) ) << Min Date( Date MDY( 10, 3, 1989 ) ) <<
Max Date( Date MDY( 10, 7, 1989 ) );
Show( Abbrev Date( cal << Get Max Date ) );
```

### [Get Min Date](#get-min-date)[](#get-min-date "Click to copy url")

**Syntax:** obj \<\< Min Date( number ); number = obj \<\< Get Min Date

**Description:** Set the minimum date. The calendar control will be limited to selections in the correct range.
...
cal << Date( Date MDY( 10, 5, 1989 ) ) << Min Date( Date MDY( 10, 3, 1989 ) ) <<
Max Date( Date MDY( 10, 7, 1989 ) );
Show( Abbrev Date( cal << Get Min Date ) );
```

### [Get Show Time](#get-show-time)[](#get-show-time "Click to copy url")

**Syntax:** obj \<\< Show Time( state=0\|1 ); state = obj \<\< Get Show Time

**Description:** Select a time in addition to a date.

``` jsl
New Window( "Calendar Box Example", cal = Calendar Box() );
Wait( 1 );
cal << Date( Date MDY( 10, 5, 1989 ) ) << Show Time( 0 );
Show( cal << Get Show Time );
```
...
### [Max Date](#max-date)[](#max-date "Click to copy url")
...
### [Min Date](#min-date)[](#min-date "Click to copy url")
...
**Syntax:** obj \<\< Set Function( Function( {thisBox, date}, \<script\> ) )

**Description:** Sets the given function for the control. The function's script runs when a date is clicked. date is the current selected date.

**JMP Version Added:** 14

``` jsl
New Window( "Calendar Box Example", cal = Calendar Box() );
cal << Set Function( Function( {thisBox, date}, Show( As Date( date ) ) ) );
```
...
### [Show Time](#show-time)[](#show-time "Click to copy url")
...
[ Previous](ButtonBox.html "ButtonBox") [Next ](CellPlotBox.html "CellPlotBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/CellPlotBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/CellPlotBox.html)*

---

# [CellPlotBox](#cellplotbox)[](#cellplotbox "Click to copy url")

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Color Theme](#color-theme)[](#color-theme "Click to copy url")

**Syntax:** obj \<\< Color Theme( Green to Black to Red\|Green to White to Red\|White to Black\|Blue to Gray to Red\|Blue to Green to Red\|Spectral\|Jet\|White to Blue\|White to Green\|White to Red )

**Description:** Specifies the range of colors to use when displaying the cell plot.
...
### [Graph Type](#graph-type)[](#graph-type "Click to copy url")

**Syntax:** obj \<\< Graph Type( "Color Map"\|"Dot Plot"\|"VLine Plot"\|"HLine Plot"\|"HBar Plot" )

**Description:** Specifies the visual style of the cell plot.
...
### [No separator lines](#no-separator-lines)[](#no-separator-lines "Click to copy url")

**Syntax:** obj \<\< No separator lines( state=0\|1 )

**Description:** Removes the lines that are drawn around each column in the cell plot.
...
**Description:** Bring up the Row Editor window, starting with the first selected point.
...
**Syntax:** obj \<\< Sort Descending

**Description:** Sorts the values in descending order.
...
[ Previous](CalendarBox.html "CalendarBox") [Next ](CenterBox.html "CenterBox")

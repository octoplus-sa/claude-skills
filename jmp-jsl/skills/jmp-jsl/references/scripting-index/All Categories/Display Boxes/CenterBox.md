...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/CenterBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/CenterBox.html)*

---

# [CenterBox](#centerbox)[](#centerbox "Click to copy url")
...
**Description:** Returns if the Center Box is horizontal (1) or vertical (0).

``` jsl
New Window( "Example",
    Outline Box( "Outline Box",
        vlb = V List Box(
            hcb = H Center Box( Text Edit Box( "Centered" ) ),
            H List Box( Text Edit Box( "Bottom Left" ), Text Edit Box( "Bottom Right" ) )
        )
    )
);
Print( "Horizontal Center Box:", hcb << Get Horizontal );
```
...
**Description:** Sets the Center Box to horizontal (1) or vertical (0).
...
[ Previous](CellPlotBox.html "CellPlotBox") [Next ](CheckBoxBox.html "CheckBoxBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/CrosstabBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/CrosstabBox.html)*

---

# [CrosstabBox](#crosstabbox)[](#crosstabbox "Click to copy url")

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Format](#format)[](#format "Click to copy url")

**Syntax:** obj \<\< Format( element, Format( format, \<options\> ) )

**Description:** Sets the format for the given CrossTabBox element

``` jsl
Open( "$SAMPLE_DATA/Alcohol.jmp" );
c = Contingency(
    Y( :Relapsed ),
...
ctb << Format( "Col %", Format( "Fixed Dec", 7, 1 ) );
```
...
**Description:** Returns a matrix of the values in the CrossTabBox.
...
**Description:** Creates a new data table that contains the values in the CrossTabBox.
...
cr = c << report;
ctb = cr[CrosstabBox( 1 )];
ctb << Make Into Data Table( invisible( 1 ) );
```
...
[ Previous](ContourSeg.html "ContourSeg") [Next ](CustomBox.html "CustomBox")

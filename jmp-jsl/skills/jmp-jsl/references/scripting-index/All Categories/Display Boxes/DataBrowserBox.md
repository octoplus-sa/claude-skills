...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/DataBrowserBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/DataBrowserBox.html)*

---

# [DataBrowserBox](#databrowserbox)[](#databrowserbox "Click to copy url")
...
**Description:** Makes a data table view in a display box tree. Changes the current data table to the given data table.
...
**Syntax:** obj \<\< Close Data Grid( state=0\|1 )

**Description:** Close or open the data table grid.
...
**Syntax:** obj \<\< Close Side Panels( state=0\|1 )
...
**Syntax:** obj \<\< Close summary panels( state=0\|1 )
...
### [Get Close Data Grid](#get-close-data-grid)[](#get-close-data-grid "Click to copy url")

**Syntax:** obj \<\< Get Close Data Grid

**Description:** Returns the closed state of the data table grid.
...
dg << Close Data Grid( 1 );
Show( dg << Get Close Data Grid );
```

### [Get Close Side Panels](#get-close-side-panels)[](#get-close-side-panels "Click to copy url")

**Syntax:** obj \<\< Get Close Side Panels

**Description:** Returns the closed state of the data tables's side panels.
...
dg << Close Side Panels( 1 );
Show( dg << Get Close Side Panels );
```

### [Get Close Summary Panels](#get-close-summary-panels)[](#get-close-summary-panels "Click to copy url")

**Syntax:** obj \<\< Get Close Summary Panels

**Description:** Returns the closed state of the data tables's summary panels.
...
dg << Close Summary Panels( 0 );
Show( dg << Get Close Summary Panels );
```
...
**Description:** returns the data table for this display box

``` jsl

dt1 = Open( "$SAMPLE_DATA/Big Class.jmp", invisible );
dt2 = Open( "$SAMPLE_DATA/Animals.jmp", invisible );
New Window( "School",
    H List Box(
        dg = dt1 << New Data Box(),
        dt1 << Distribution( ContinuousDistribution( Column( :weight ) ) )
    )
);
dg << Get Data Table;
```
...
dg << Set Cell Height( 20 );
```

### [Set Data Table](#set-data-table)[](#set-data-table "Click to copy url")

**Syntax:** obj \<\< Set Data Table( dt )

**Description:** sets the data table for this display box
...
[ Previous](DFIntMinMaxBox.html "DFIntMinMaxBox") [Next ](DataColumnNameBox.html "DataColumnNameBox")

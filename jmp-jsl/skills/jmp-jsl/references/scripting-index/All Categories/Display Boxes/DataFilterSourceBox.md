...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/DataFilterSourceBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/DataFilterSourceBox.html)*

---

# [DataFilterSourceBox](#datafiltersourcebox)[](#datafiltersourcebox "Click to copy url")
...
### [Get Filter](#get-filter)[](#get-filter "Click to copy url")

**Syntax:** obj \<\< Get Filter

### [Set Row States](#set-row-states)[](#set-row-states "Click to copy url")

**Syntax:** obj \<\< Set Row States( dt, rs )

**Description:** Sets the row states for the given data table within the filter. Selections made in this row state will not be linked with the data table, but will be included in the reports linked to the selection filter.
...
[ Previous](DataFilterContextBox.html "DataFilterContextBox") [Next ](DataTableColBox.html "DataTableColBox")

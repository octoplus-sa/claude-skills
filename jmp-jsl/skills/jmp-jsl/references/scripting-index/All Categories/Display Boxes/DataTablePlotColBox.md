...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/DataTablePlotColBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/DataTablePlotColBox.html)*

---

# [DataTablePlotColBox](#datatableplotcolbox)[](#datatableplotcolbox "Click to copy url")
...
nw = New Window( "Example",
    Table Box( Data Table Col Box( :name ), col = pcb = Data Table Plot Col Box( :height ) )
);
...
### [Col ID](#col-id)[](#col-id "Click to copy url")

**Syntax:** obj \<\< Col ID( state=0\|1 )

**JMP Version Added:** 17

### [Copy Column](#copy-column)[](#copy-column "Click to copy url")
...
### [Copy Selected Column Rows](#copy-selected-column-rows)[](#copy-selected-column-rows "Click to copy url")
...
### [Dot](#dot)[](#dot "Click to copy url")

**Syntax:** obj \<\< Dot

**Description:** Shows a dot rather than a bar.
...
**Syntax:** matrix = obj \<\< Get As Matrix

**Description:** Returns the values in a matrix, specifically a column vector.
...
### [Get Axis Position](#get-axis-position)[](#get-axis-position "Click to copy url")

**Syntax:** "Default"\|"Top"\|"Bottom" = obj \<\< Get Axis Position

**Description:** Get the axis position for the plot col. The default is for it to sometimes show on the top depending on the scale and title.
...
### [Get Bar Color](#get-bar-color)[](#get-bar-color "Click to copy url")

**Syntax:** obj \<\< Get Bar Color

**Description:** Get the color of the plot bars
...
### [Get Bar Select Color](#get-bar-select-color)[](#get-bar-select-color "Click to copy url")

**Syntax:** obj \<\< Get Bar Select Color

**Description:** Get the color of the plot bars when in a selected row
...
### [Get Base Data Font](#get-base-data-font)[](#get-base-data-font "Click to copy url")
...
### [Get Col ID](#get-col-id)[](#get-col-id "Click to copy url")

**Syntax:** obj \<\< Get Col ID( state=0\|1 )

**JMP Version Added:** 17

### [Get Data Font Name](#get-data-font-name)[](#get-data-font-name "Click to copy url")
...
### [Get Data Font Scale](#get-data-font-scale)[](#get-data-font-scale "Click to copy url")
...
### [Get Data Font Size](#get-data-font-size)[](#get-data-font-size "Click to copy url")
...
### [Get Data Font Style](#get-data-font-style)[](#get-data-font-style "Click to copy url")
...
### [Get Data Table Column](#get-data-table-column)[](#get-data-table-column "Click to copy url")
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
(pcb << Get Data Table Column()) << Get Name();
```
...
### [Get Heading](#get-heading)[](#get-heading "Click to copy url")
...
### [Get Labels](#get-labels)[](#get-labels "Click to copy url")

**Syntax:** list = obj \<\< Get Labels

**Description:** Returns the labels for each row.
...
### [Get primary interval line properties](#get-primary-interval-line-properties)[](#get-primary-interval-line-properties "Click to copy url")

**Syntax:** {color if upper \< reference line, color if crosses reference line, color if lower \> reference line, alpha, line width, pen style, cap length } = obj \<\< Get primary interval line properties

### [Get secondary interval line properties](#get-secondary-interval-line-properties)[](#get-secondary-interval-line-properties "Click to copy url")

**Syntax:** {color if upper \< reference line, color if crosses reference line, color if lower \> reference line, alpha, line width, pen style, cap length } = obj \<\< Get secondary interval line properties
...
### [Lower](#lower)[](#lower "Click to copy url")

**Syntax:** obj \<\< Lower( data table column )

**Description:** Lower limit draws a curve at the points specified.
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
dt << New Column( "Lower", Formula( :height - 5 ) );
pcb << Lower( :Lower );
```

### [Lower2](#lower2)[](#lower2 "Click to copy url")

**Syntax:** obj \<\< Lower2( list\|matrix )
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
dt << New Column( "Lower", Formula( :height - 5 ) );
dt << New Column( "Lower2", Formula( :height - 10 ) );
pcb << Lower( :Lower );
pcb << Lower2( :Lower2 );
```

### [Marks](#marks)[](#marks "Click to copy url")

**Syntax:** obj \<\< Marks

**Description:** Shows markers at the limits of each value.
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
pcb << Set Axis( Min( 0 ), Max( 100 ), Scale( "Log", {Log Base( 2 )} ), Minor Ticks( 1 ), );
```

### [Set Axis Position](#set-axis-position)[](#set-axis-position "Click to copy url")

**Syntax:** obj \<\< Set Axis Position( "Default"\|"Top"\|"Bottom" )

**Description:** Set the axis for the plot col to always be on top or bottom. The default is for it to sometimes show on the top depending on the scale and title.
...
### [Set Bar Color](#set-bar-color)[](#set-bar-color "Click to copy url")

**Syntax:** obj \<\< Set Bar Color( color )

**Description:** Set the color of the plot bars
...
### [Set Bar Select Color](#set-bar-select-color)[](#set-bar-select-color "Click to copy url")

**Syntax:** obj \<\< Set Bar Select Color( color )

**Description:** Set the color of the plot bars when in a selected row
...
### [Set Base Data Font](#set-base-data-font)[](#set-base-data-font "Click to copy url")
...
### [Set Col ID](#set-col-id)[](#set-col-id "Click to copy url")

**Syntax:** obj \<\< Set Col ID( state=0\|1 )

**JMP Version Added:** 17

### [Set Data Font](#set-data-font)[](#set-data-font "Click to copy url")
...
### [Set Data Font Name](#set-data-font-name)[](#set-data-font-name "Click to copy url")
...
### [Set Data Font Scale](#set-data-font-scale)[](#set-data-font-scale "Click to copy url")
...
### [Set Data Font Size](#set-data-font-size)[](#set-data-font-size "Click to copy url")
...
### [Set Data Font Style](#set-data-font-style)[](#set-data-font-style "Click to copy url")
...
### [Set Data Table Column](#set-data-table-column)[](#set-data-table-column "Click to copy url")
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
pcb << Set Data Table Column( :weight );
```

### [Set Heading](#set-heading)[](#set-heading "Click to copy url")
...
### [Set Labels](#set-labels)[](#set-labels "Click to copy url")

**Syntax:** obj \<\< Set Labels( data table column )

**Description:** Sets the labels for each row.
...
### [Set Plot Style](#set-plot-style)[](#set-plot-style "Click to copy url")

**Syntax:** obj \<\< Set Plot Style( "Default"\|"Bar"\|"Interval" )

**Description:** Changes the visual representation of the plot column.
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
dt << New Column( "Lower", Formula( :height - 5 ) );
dt << New Column( "Upper", Formula( :height + 5 ) );
pcb << Lower( :Lower );
pcb << Upper( :Upper );
pcb << Set Plot Style( "Interval" );
```

### [Set Reference Line](#set-reference-line)[](#set-reference-line "Click to copy url")

**Syntax:** obj \<\< Set Reference Line( number )
...
pcb << Upper( :Upper );
pcb << Set Plot Style( "Interval" );
pcb << Set Reference Line( 60 );
```

### [Set Resizable](#set-resizable)[](#set-resizable "Click to copy url")
...
**Syntax:** obj \<\< Set Scale( minimum, maximum, \<format name\>, \<width\> \| \<width, decimal places\>, \< "Use thousands separator"\> )

**Description:** Sets the minimum and maximum scale of the PlotColBox. The format parameters specify a format that is only used if the first two parameters are 0 and 1.
...
### [Set Smart Shrinking](#set-smart-shrinking)[](#set-smart-shrinking "Click to copy url")
...
**Description:** Sets the width (in pixels) of the PlotColBox.
...
### [Set primary interval line properties](#set-primary-interval-line-properties)[](#set-primary-interval-line-properties "Click to copy url")
...
### [Set secondary interval line properties](#set-secondary-interval-line-properties)[](#set-secondary-interval-line-properties "Click to copy url")

**Syntax:** obj \<\< Set secondary interval line properties( {color if upper \< reference line, color if crosses reference line, color if lower \> reference line, alpha, line width, pen style, cap length } )

### [Significance](#significance)[](#significance "Click to copy url")

**Syntax:** obj \<\< Significance( data table column )

**Description:** Used to size the marker when the plot col is in interval mode.
...
nw[Table Box( 1 )] << set scrollable( 10, 0 );
dt << New Column( "Sig", Formula( Row() ) );
pcb << Significance( :Sig );
pcb << Set Plot Style( "Interval" );
```

### [Upper](#upper)[](#upper "Click to copy url")

**Syntax:** obj \<\< Upper( data table column )

**Description:** Upper limit draws a curve at the points specified. A lower limit must first be specified.
...
### [Upper2](#upper2)[](#upper2 "Click to copy url")

**Syntax:** obj \<\< Upper2( list\|matrix )
...
dt << New Column( "Upper", Formula( :height + 5 ) );
dt << New Column( "Lower2", Formula( :height - 10 ) );
dt << New Column( "Upper2", Formula( :height + 10 ) );
pcb << Lower( :Lower );
pcb << Lower2( :Lower2 );
pcb << Upper( :Upper );
pcb << Upper2( :Upper2 );
...
[ Previous](DataTableColBox.html "DataTableColBox") [Next ](Design%20Box.html "Design Box")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/FilterColSelector.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/FilterColSelector.html)*

---

# [FilterColSelector](#filtercolselector)[](#filtercolselector "Click to copy url")
...
**Description:** Include or exclude columns with modeling type 'none' from the list.
...
**Syntax:** obj \<\< Character( (0 \| 1) )

**Description:** Include or exclude character columns from the list.
...
**Syntax:** obj \<\< Continuous( (0 \| 1) )

**Description:** Include or exclude continuous columns from the list.
...
**Syntax:** obj \<\< Expression( (0 \| 1) )

**Description:** Include or exclude expression columns from the list.
...
### [Match case](#match-case)[](#match-case "Click to copy url")

**Syntax:** obj \<\< Match case( (0 \| 1) )

**Description:** Column search is case sensitive or not.
...
**Syntax:** obj \<\< Multiple Response( (0 \| 1) )

**Description:** Include or exclude multiple response columns from the list.
...
### [Name contains](#name-contains)[](#name-contains "Click to copy url")

**Syntax:** obj \<\< Name contains( Name contains( s ) )

**Description:** List only the columns whose names contain the given text.
...
### [Name ends with](#name-ends-with)[](#name-ends-with "Click to copy url")

**Syntax:** obj \<\< Name ends with( Name ends with ( text ) )

**Description:** List only the columns whose names end with the given text.
...
### [Name starts with](#name-starts-with)[](#name-starts-with "Click to copy url")

**Syntax:** obj \<\< Name starts with( Name starts with ( text ) )

**Description:** List only the columns whose names start with the given text.
...
### [Nominal](#nominal)[](#nominal "Click to copy url")

**Syntax:** obj \<\< Nominal( (0 \| 1) )

**Description:** Include or exclude nominal columns from the list.
...
**Syntax:** obj \<\< Numeric( (0 \| 1) )

**Description:** Include or exclude numeric columns from the list.
...
### [Ordinal](#ordinal)[](#ordinal "Click to copy url")

**Syntax:** obj \<\< Ordinal( (0 \| 1) )

**Description:** Include or exclude ordinal columns from the list.
...
**Description:** Reset the columns list to the entire list.
...
**Syntax:** obj \<\< Set Selected( index,\<selected\> )

**Description:** Sets the item at index to be selected (1) or deselected (0).
...
### [Sort by name](#sort-by-name)[](#sort-by-name "Click to copy url")

**Syntax:** obj \<\< Sort by name

**Description:** Sort the column list by name.
...
**Syntax:** obj \<\< Unstructured Text( (0 \| 1) )

**Description:** Include or exclude unstructured text columns from the list.
...
### [Vector](#vector)[](#vector "Click to copy url")

**Syntax:** obj \<\< Vector( (0 \| 1) )

**Description:** Include or exclude vector columns from the list.
...
[ Previous](ExcerptBox.html "ExcerptBox") [Next ](FilterFieldBox.html "FilterFieldBox")

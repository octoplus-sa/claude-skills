...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/GraphBuilderBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/GraphBuilderBox.html)*

---

# [GraphBuilderBox](#graphbuilderbox)[](#graphbuilderbox "Click to copy url")
...
**Description:** Internal component of Graph Builder.
...
### [Get Graph Margin](#get-graph-margin)[](#get-graph-margin "Click to copy url")

**Syntax:** obj \<\< Graph Margin( sides ); sides = obj \<\< Get Graph Margin

**Description:** The minimum margin around the graph area, which might be superseded by any surrounding axis, legend, or title.
...
### [Get Scale Graph Margin](#get-scale-graph-margin)[](#get-scale-graph-margin "Click to copy url")

**Syntax:** obj \<\< Scale Graph Margin( state=0\|1 ); state = obj \<\< Get Scale Graph Margin

**Description:** Specifies whether the Graph Margin properties should scale with the graph size when applied.
...
**Syntax:** obj \<\< Graph Borders( color )
...
Wait( 0.5 );
gb << Graph Spacing( 5 );
gb << Graph Transparency( 0 );
gb << Graph Borders( 1 );
```

### [Graph Margin](#graph-margin)[](#graph-margin "Click to copy url")
...
**Syntax:** obj \<\< Graph Spacing( color )

**Description:** Sets the amount of spacing between graph panels.
...
**Description:** Sets the color of the spacing between graph panels.
...
gb << Add Variable( {:age, Role( "Wrap" )} );
Wait( 0.5 );
gb << Graph Spacing Color( "Blue" );
```

### [Graph Spacing Transparency](#graph-spacing-transparency)[](#graph-spacing-transparency "Click to copy url")

**Syntax:** obj \<\< Graph Spacing Transparency( color )

**Description:** Sets the transparency of the spacing between graph panels.
...
gb << Add Variable( {:age, Role( "Wrap" )} );
Wait( 0.5 );
gb << Graph Spacing Transparency( 0.3 );
```
...
### [Scale Graph Margin](#scale-graph-margin)[](#scale-graph-margin "Click to copy url")
...
[ Previous](GlobalBox.html "GlobalBox") [Next ](GridCellBox.html "GridCellBox")

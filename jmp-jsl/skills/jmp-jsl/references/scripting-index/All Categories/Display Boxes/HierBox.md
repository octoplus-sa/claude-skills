...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/HierBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/HierBox.html)*

---

# [HierBox](#hierbox)[](#hierbox "Click to copy url")
...
**Description:** Returns a display box that contains a hierarchy of strings.
...
New Window( "Example",
    ggparent = Hier Box(
        ...
        gparent1 = Hier Box(
            "Grand Parent 1",
            parent1 = Hier Box( "Parent 1" ),
            parent2 = Hier Box( "Parent 2" )
        ),
        fontobj = gparent2 = Hier Box(
            "Grand Parent 2",
            parent3 = Hier Box(
                "Parent 3",
                child1 = Hier Box( "Child 1" ),
                child2 = Hier Box( "Child 2" )
            ),
            parent4 = Hier Box( "Parent 4" )
        )
    )
);
```
...
### [Above](#above)[](#above "Click to copy url")

**Syntax:** obj \<\< Above( "string" )

**Description:** Inserts a new string above the calling HierBox.
...
parent4 << Above( "New Parent" );
```

### [After](#after)[](#after "Click to copy url")

**Syntax:** obj \<\< After( "string" )

**Description:** Inserts a new string after the calling HierBox.
...
parent4 << After( "New Parent" );
```

### [Before](#before)[](#before "Click to copy url")

**Syntax:** obj \<\< Before( "string" )

**Description:** Inserts a new string before the calling HierBox.
...
parent4 << Before( "New Parent" );
```

### [Below](#below)[](#below "Click to copy url")

**Syntax:** obj \<\< Below( "string" )

**Description:** Inserts a new string below the calling HierBox.
...
parent4 << Below( "New Child" );
```

### [Change Type](#change-type)[](#change-type "Click to copy url")

**Syntax:** obj \<\< Change Type( "Fishbone"\|"Hierarchy"\|"Nested" )

**Description:** Sets the style of the Hier Box.
...
ggparent << Change Type( "hierarchy" );
```
...
**Description:** Hide all of the children under the given Hier Box.
...
**Description:** Remove the Hier Box.
...
### [Direction](#direction)[](#direction "Click to copy url")

**Syntax:** obj \<\< Direction( 0\|1 )

**Description:** Sets if the strings in the HierBox should point right (1) or left (0).
...
**Description:** Move the calling HierBox to be the first HierBox.
...
### [Force Alternate](#force-alternate)[](#force-alternate "Click to copy url")

**Syntax:** obj \<\< Force Alternate

**Description:** Moves the calling HierBox to be alternating with the sibling HierBox.
...
ggparent << Force Alternate;
```

### [Force Down](#force-down)[](#force-down "Click to copy url")

**Syntax:** obj \<\< Force Down

**Description:** Moves the calling HierBox down.
...
### [Force Left](#force-left)[](#force-left "Click to copy url")

**Syntax:** obj \<\< Force Left

**Description:** Moves the calling HierBox to the left.
...
ggparent << Force Up;
ggparent << Force Right;
ggparent << Force Left;
```

### [Force Right](#force-right)[](#force-right "Click to copy url")

**Syntax:** obj \<\< Force Right

**Description:** Moves the calling HierBox to the right.
...
### [Force Up](#force-up)[](#force-up "Click to copy url")

**Syntax:** obj \<\< Force Up

**Description:** Moves the calling HierBox up.
...
**Syntax:** obj \<\< Horizontal

**Description:** Rotate the text to be horizontal that starts on the left.
...
gparent1 << Rotate Right;
gparent1 << Horizontal;
```

### [Last](#last)[](#last "Click to copy url")

**Syntax:** obj \<\< Last

**Description:** Move the calling HierBox to be the last HierBox.
...
### [Lean](#lean)[](#lean "Click to copy url")

**Syntax:** obj \<\< Lean( 0\|1 )

**Description:** Sets if the strings in the HierBox should lean right (1) or left (0).
...
**Description:** Creates a new data table that contains the strings in the HierBox.
...
ggparent << Make into Data Table( invisible( 1 ) );
```

### [Other Side](#other-side)[](#other-side "Click to copy url")

**Syntax:** obj \<\< Other Side

**Description:** Move the calling HierBox to the other side of the other HierBoxs.
...
### [Override Descendant Padding](#override-descendant-padding)[](#override-descendant-padding "Click to copy url")

**Syntax:** obj \<\< Override Descendant Padding( state=0\|1 )

**Description:** This is true if all descendants adopt the same padding setup prescribed.
...
ggparent << Override Descendant Padding( false );
```

### [Pad Current Node](#pad-current-node)[](#pad-current-node "Click to copy url")

**Syntax:** obj \<\< Pad Current Node( state=0\|1 )

**Description:** This is true if we apply the prescribed padding setup to the current node.
...
ggparent << Pad Current Node( false );
```

### [Rotate Left](#rotate-left)[](#rotate-left "Click to copy url")

**Syntax:** obj \<\< Rotate Left

**Description:** Rotate the text to be vertical that starts at the bottom.
...
gparent1 << Rotate Left;
```

### [Rotate Right](#rotate-right)[](#rotate-right "Click to copy url")

**Syntax:** obj \<\< Rotate Right

**Description:** Rotate the text to be vertical that starts at the top.
...
### [Siblings Horizontal Pad](#siblings-horizontal-pad)[](#siblings-horizontal-pad "Click to copy url")

**Syntax:** obj \<\< Siblings Horizontal Pad( number )

**Description:** This is the usual padding between hierboxes.
...
ggparent << Siblings Horizontal Pad( 4 );
```

### [Siblings Total Pad](#siblings-total-pad)[](#siblings-total-pad "Click to copy url")

**Syntax:** obj \<\< Siblings Total Pad( number )

**Description:** This is the vertical padding between sibling hierboxes and their parent box.
...
ggparent << Siblings Total Pad( 15 );
```

### [Siblings Vertical Pad](#siblings-vertical-pad)[](#siblings-vertical-pad "Click to copy url")

**Syntax:** obj \<\< Siblings Vertical Pad( number )

**Description:** This is the padding between hierboxes when rotated 90 degrees.
...
ggparent << Siblings Vertical Pad( 4 );
```

### [Text Wrap Width](#text-wrap-width)[](#text-wrap-width "Click to copy url")

**Syntax:** obj \<\< Text Wrap Width( width )

**Description:** Specifies the width each string can be before the string starts a new line.
...
ggparent << Text Wrap Width( 60 );
```

### [Uneditable](#uneditable)[](#uneditable "Click to copy url")

**Syntax:** obj \<\< Uneditable( state=0\|1 )

**Description:** If enabled (1), strings can be clicked on with a mouse to be edited.
...
[ Previous](HelpBox.html "HelpBox") [Next ](HistSeg.html "HistSeg")

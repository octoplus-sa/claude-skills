...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/LegendBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/LegendBox.html)*

---

# [LegendBox](#legendbox)[](#legendbox "Click to copy url")

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Get Item](#get-item)[](#get-item "Click to copy url")

**Syntax:** LegendBox \<\< Get Item(Model ID, Model Index)

**Description:** Returns a Legend Item that can be queried or have its visible properties changed.
...
lgnd = gb << Get Legend Display;
item = lgnd << Get Item( 1, 4 );
item << Set Label( "test" );
```

### [Get Items](#get-items)[](#get-items "Click to copy url")

**Syntax:** obj \<\< Get Items

**Description:** Returns a list of all Legend Items that can be queried or have their visible properties changed.
...
### [Get Model](#get-model)[](#get-model "Click to copy url")

**Syntax:** obj \<\< Get Model
...
**Syntax:** obj \<\< Legend Position( list )

**Description:** Rearranges the items within the LegendBox according to the inputted list.
...
Report( gb )[LegendBox( 1 )] << Legend Position( {3, [4, 3], 4, [2, 1]} );
```
...
**Description:** Bring up the Legend window to change various settings.
...
gb = Graph Builder(
    Show Control Panel( 0 ),
    Variables( X( :height ), Y( :weight ), Overlay( :sex ) ),
    Elements( Points( X, Y, Legend( 0 ) ), Smoother( X, Y, Legend( 1 ) ) )
);
Report( gb )[LegendBox( 1 )] << Legend Settings;
```
...
**Description:** Sets the direction that the items within the LegendBox should face.
...
Report( gb )[LegendBox( 1 )] << Orientation( "horizontal" );
```

### [Revert Legend](#revert-legend)[](#revert-legend "Click to copy url")

**Syntax:** obj \<\< Revert Legend

**Description:** Reverts any changes made to the LegendBox.
...
Report( gb )[LegendBox( 1 )] << Set Title( "Gender" );
Report( gb )[LegendBox( 1 )] << Revert Legend;
```
...
**Description:** Specifies the maximum number of items to display in the legend. This setting prevents a noisy legend from overwhelming the graph.
...
Report( gb )[LegendBox( 1 )] << Set Max Items( 3 );
```

### [Set Title](#set-title)[](#set-title "Click to copy url")

**Syntax:** obj \<\< Set Title( "string" )

**Description:** Sets the title of the LegendBox.
...
**Syntax:** obj \<\< Set Wrap( number )

**Description:** Specifies the number of lines the legend items should appear on; 0 indicates no wrapping (i.e., a single-wide column)
...
Report( gb )[LegendBox( 1 )] << Set Wrap( 1 );
```

### [Sides](#sides)[](#sides "Click to copy url")

**Syntax:** obj \<\< Sides( top\|left )

**Description:** Sets the position of the LegendBox.
...
Report( gb )[LegendBox( 1 )] << Sides( "left" );
```

### [font](#font)[](#font "Click to copy url")

**Syntax:** obj \<\< font( fontname, \<fontsize\>, \<fontstyle\> )

**Description:** Specify the font to be used for text in the legend.
...
Report( gb )[LegendBox( 1 )] << Legend Position( {3, [4, 3], 4, [2, 1]} );
Report( gb )[LegendBox( 1 )] << Font( "Arial", 12, "Bold Italic Underline" );
```
...
Report( gb )[LegendBox( 1 )] << Legend Position( {3, [4, 3], 4, [2, 1]} );
Report( gb )[LegendBox( 1 )] << Font( "Arial", 12, 7 );
```
...
[ Previous](LabelBox.html "LabelBox") [Next ](LineSeg.html "LineSeg")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/LineUpBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/LineUpBox.html)*

---

# [LineUpBox](#lineupbox)[](#lineupbox "Click to copy url")

## [Associated Constructors](#associated-constructors)[](#associated-constructors "Click to copy url")

### [Line Up Box](#line-up-box)[](#line-up-box "Click to copy url")

**Syntax:** y = Lineup Box( \<NCol( nc )\>, \<Spacing( pixels, \<vspace\> )\>, displayBoxArgs, ... )

**Description:** Returns a display box that neatly arranges the display boxes that it contains.

``` jsl
New Window( "Enter Numbers",
    <<Modal,
    <<Return Result,
    V List Box(
...
### [Get N Col](#get-n-col)[](#get-n-col "Click to copy url")

**Syntax:** obj \<\< Get N Col
...
### [Get Spacing](#get-spacing)[](#get-spacing "Click to copy url")

**Syntax:** pixels = obj \<\< Get Spacing( number )

**Description:** Gets the number of pixels that should separate the display boxes.
...
New Window( "Example", V List Box( lineupbox ) );
lineupbox << get spacing();
```

### [NCol](#ncol)[](#ncol "Click to copy url")

**Syntax:** obj \<\< NCol( number )
...
### [Spacing](#spacing)[](#spacing "Click to copy url")

**Syntax:** obj \<\< Spacing( pixels )

**Description:** Sets the number of pixels that should separate the display boxes.
...
New Window( "Example", V List Box( lineupbox ) );
lineupbox << spacing( 20 );
```

### [Wrap When Printing](#wrap-when-printing)[](#wrap-when-printing "Click to copy url")

**Syntax:** obj \<\< Wrap When Printing

**Description:** Lineup will wrap as needed when printing.

``` jsl
Open( "$SAMPLE_DATA/PopAgeGroup.jmp" );
dist = Distribution(
    Arrange in Rows( 4 ),
    Continuous Distribution( Column( :Pop ) ),
    Continuous Distribution( Column( :"Pop Age 0-19"n ) ),
    Continuous Distribution( Column( :"Pop Age 20-59"n ) ),
    Continuous Distribution( Column( :"Pop Age 60+"n ) ),
    Continuous Distribution( Column( :"Portion 0-19"n ) ),
    Continuous Distribution( Column( :"Portion20-59"n ) ),
    Continuous Distribution( Column( :"Portion60+"n ) ),
    Continuous Distribution( Column( :"F Rate 0-19"n ) ),
    Continuous Distribution( Column( :"F Rate 20-59"n ) ),
    Continuous Distribution( Column( :"F Rate 60+"n ) )
);
(dist << Report)[Lineup Box( 1 )] << Wrap When Printing( 1 );
(dist << Report) << Save PDF( "$TEMP/JMPExample.pdf" );
Open( "$TEMP/JMPExample.pdf" );
```
...
[ Previous](LineSeg.html "LineSeg") [Next ](LineUpRulerBox.html "LineUpRulerBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/NomAxisBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/NomAxisBox.html)*

---

# [NomAxisBox](#nomaxisbox)[](#nomaxisbox "Click to copy url")

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Divider Lines](#divider-lines)[](#divider-lines "Click to copy url")

**Syntax:** obj \<\< Divider Lines

**Description:** Draws divider-line tick marks on the axis.
...
**Description:** Draws divider-line tick marks on inside of the graph frame
...
### [Lower Frame](#lower-frame)[](#lower-frame "Click to copy url")

**Syntax:** obj \<\< Lower Frame( state=0\|1 )

**Description:** Enables or disables a lower frame from appearing on the axis.
...
### [Off](#off)[](#off "Click to copy url")

**Syntax:** obj \<\< Off

**Description:** Removes the tick marks from the axis.
...
### [Rotated Tick Labels](#rotated-tick-labels)[](#rotated-tick-labels "Click to copy url")

**Syntax:** obj \<\< Rotated Tick Labels( state=0\|1 )

**Description:** Rotates the tick labels horizontally (1) or vertically (0).
...
New Window( "Example",
    cp = Cell Plot(
        ...
        Y(
            :"2004 Verbal"n, :"2004 Math"n, :"2003 Verbal"n, :"2003 Math"n, :"2002 Verbal"n,
            :"2002 Math"n, :"2001 Verbal"n, :"2001 Math"n
        )
    )
);
cpr = cp << report;
cpb = cpr[Cell Plot Box( 1 )];
cpb << Frame Size( 600, 500 );
axis = cpr[Nom Axis Box( 1 )];
axis << Rotated Tick Labels( 0 );
```

### [Short](#short)[](#short "Click to copy url")

**Syntax:** obj \<\< Short

**Description:** Draws short tick marks on the axis.
...
[ Previous](NodeDisplayNewArcBox.html "NodeDisplayNewArcBox") [Next ](NumberBox.html "NumberBox")

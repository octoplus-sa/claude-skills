...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/NumberColEditBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/NumberColEditBox.html)*

---

# [NumberColEditBox](#numbercoleditbox)[](#numbercoleditbox "Click to copy url")
...
**Description:** Returns a display box that displays editable numbers in a column.

``` jsl
New Window( "Example",
    col = Number Col Edit Box(
        "Random Numbers",
...
### [Align Decimal Separator](#align-decimal-separator)[](#align-decimal-separator "Click to copy url")

**Syntax:** obj \<\< Align Decimal Separator( state=0\|1 )

**Description:** Specifies that the values in the column are vertically aligned using the decimal separator.
...
### [Enable Semantic Formats](#enable-semantic-formats)[](#enable-semantic-formats "Click to copy url")

**Syntax:** obj \<\< Enable Semantic Formats( state=0\|1 )

**Description:** Controls whether semantic formats are applied to the column. Semantic formats can also be controlled via preferences.
...
### [Get Align Decimal Separator](#get-align-decimal-separator)[](#get-align-decimal-separator "Click to copy url")

**Syntax:** obj \<\< Get Align Decimal Separator

**Description:** Returns 1 if the column aligns values on the decimal separator, 0 otherwise.
...
### [Get Conditional Format](#get-conditional-format)[](#get-conditional-format "Click to copy url")

**Syntax:** format = obj \<\< Get Conditional Format

**Description:** Returns the conditional format.
...
### [Get Effective Format](#get-effective-format)[](#get-effective-format "Click to copy url")

**Syntax:** obj \<\< Get Effective Format( \<row\> )

**Description:** Returns the column's effective format, that is the format after applying any matching semantic format. If row is given, returns the effective format for just that row.
...
### [Get Enable Semantic Formats](#get-enable-semantic-formats)[](#get-enable-semantic-formats "Click to copy url")

**Syntax:** obj \<\< Get Enable Semantic Formats

**Description:** Returns the Enable Semantic Formats setting for the column. Semantic formats can also be controlled via preferences.
...
**Syntax:** width,\<decimalplaces\> = obj \<\< Get Format

**Description:** Returns the current format (width, decimalplaces). A decimalplaces \> 100 indicates date/time values.
...
col << Set Function(
    Function( {this, which},
        Print( "row " || Char( which ) || " changed to " || Char( col << Get( which ) ) )
    )
);
col << Get Function;
```
...
### [Hide Missing Values](#hide-missing-values)[](#hide-missing-values "Click to copy url")

**Syntax:** obj \<\< Hide Missing Values( state=0\|1 )

**Description:** Missing values will not be shown when set to 1
...
### [Set Conditional Format](#set-conditional-format)[](#set-conditional-format "Click to copy url")

**Syntax:** obj \<\< Set Conditional Format( "Correlation"\|"PValue"\|"Factor Pattern" )

**Description:** Sets the conditional format.
...
**Description:** Set the format of the numbers to display.

#### [Currency](#currency)[](#currency "Click to copy url")
...
#### [Duration](#duration)[](#duration "Click to copy url")
...
#### [Fixed](#fixed)[](#fixed "Click to copy url")
...
**Syntax:** obj \<\< Set Function( Function( {thisBox, which}, \<script\> ) )

**Description:** Sets the given function for the control. The function's script runs when a change is committed. which is the row number of the cell that changed.
...
col << Set Function(
    Function( {thisBox, which},
        Print( "row " || Char( which ) || " changed to " || Char( thisBox << Get( which ) ) )
    )
);
```
...
**Syntax:** obj \<\< Set Values( matrix )

**Description:** Updates the NumberColBox to the values provided.
...
[ Previous](NumberColBox.html "NumberColBox") [Next ](NumberEditBox.html "NumberEditBox")

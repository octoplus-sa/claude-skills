...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/NumberEditBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/NumberEditBox.html)*

---

# [NumberEditBox](#numbereditbox)[](#numbereditbox "Click to copy url")
...
``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
```

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Decrement](#decrement)[](#decrement "Click to copy url")

**Syntax:** obj \<\< Decrement

**Description:** Decrements the value by the current setting.

``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
numbox << Set Increment( 1 );
numbox << Set( 0 );
Wait( 2 );
numbox << Decrement;
```
...
**Description:** Returns the number currently entered in the edit box
...
### [Get Exclude Maximum](#get-exclude-maximum)[](#get-exclude-maximum "Click to copy url")

**Syntax:** obj \<\< Get Exclude Maximum

**Description:** If set, the maximum value is excluded from the valid range of numbers.

``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
numbox << Set Maximum( 100 );
numbox << Set Exclude Maximum( 1 );
numbox << Set( 100 );
numbox << Get Exclude Maximum;
```

### [Get Exclude Minimum](#get-exclude-minimum)[](#get-exclude-minimum "Click to copy url")

**Syntax:** obj \<\< Get Exclude Minimum

**Description:** If set, the minimum value is excluded from the valid range of numbers.

``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
numbox << Set Minimum( 0 );
numbox << Set Exclude Minimum( 1 );
numbox << Set( 0 );
numbox << Get Exclude Minimum;
```
...
**Syntax:** format = obj \<\< Get Format

**Description:** Returns the format of the number to display.

``` jsl
dt = Open( "$SAMPLE_DATA/Big Class.jmp" );
biv = dt << Bivariate( Y( :weight ), X( :height ), Kernel Smoother( 1, 1, 0.5, 0 ) );
rbiv = biv << report;
numbox = rbiv[NumberBox( 1 )];
numbox << Get Format();
```
...
New Window( "Example",
    numbox = Number Edit Box(
        ...
        10,
        <<SetFunction(
            Function( {this}, /* put my value into my sibling's display */(this << sib) <<
...
### [Get Increment](#get-increment)[](#get-increment "Click to copy url")

**Syntax:** inc = obj \<\< Get Increment

**Description:** Returns the increment value to be used for stepping control. This value will be used when the up or down arrow keys are pressed during editing or when the \<\<Increment or \<\<Decrement messages are sent.

``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
numbox << Set Increment( 1 );
numbox << Get Increment;
```

### [Get Integer Only](#get-integer-only)[](#get-integer-only "Click to copy url")

**Syntax:** obj \<\< Get Integer Only

**Description:** If set, only integer values will be allowed.

``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
numbox << Set Integer Only( 1 );
numbox << Set( 1.5 );
numbox << Get Integer Only;
```

### [Get Maximum](#get-maximum)[](#get-maximum "Click to copy url")

**Syntax:** max = obj \<\< Get Maximum

**Description:** Returns the maximum value. A value of missing indicates that there is no maximum value.
...
### [Get Minimum](#get-minimum)[](#get-minimum "Click to copy url")

**Syntax:** min = obj \<\< Get Minimum

**Description:** Returns the minimum value. A value of missing indicates that there is no minimum value.
...
### [Get Number Changed](#get-number-changed)[](#get-number-changed "Click to copy url")

**Syntax:** function = obj \<\< Get Number Changed

**Description:** Returns the function that is executed each time a change is made to the number.
...
New Window( "Example",
    numbox = Number Edit Box(
        ...
        10,
        <<Set Number Changed(
            Function( {thisBox, value}, /* put my value into my sibling's display */(thisBox
                 << sib) << settext( Char( value ) )
            )
        )
    ),
    Text Box( "" )
...
### [Get Show Spin Box](#get-show-spin-box)[](#get-show-spin-box "Click to copy url")

**Syntax:** obj \<\< Get Show Spin Box

**Description:** Returns the Spin Box setting.

``` jsl
New Window( "Example", fontobj = numbox = Number Edit Box( 0 ) );
numbox << Set Increment( 1 );
numbox << Set Show Spin Box( 1 );
numbox << Get Show Spin Box;
```
...
**Description:** Returns the tooltip of the Number Box.
...
rbiv = biv << report;
numbox = rbiv[NumberBox( 1 )];
numbox << Set Tip( "Example Tooltip" );
numbox << Get Tip();
```
...
**Description:** Returns how many characters wide the number edit box is.
...
### [Increment](#increment)[](#increment "Click to copy url")

**Syntax:** obj \<\< Increment

**Description:** Sets the increment value to be used for stepping control. This value will be used when the up or down arrow keys are pressed during editing or when the \<\<Increment or \<\<Decrement messages are sent.
...
**Description:** Sets if the TextEditBox can be edited.
...
**Syntax:** obj \<\< Set( numeric value,\<run script(0\|1)\> )

**Description:** Sets the contents of the edit box to the number that is passed in
...
### [Set Exclude Maximum](#set-exclude-maximum)[](#set-exclude-maximum "Click to copy url")

**Syntax:** obj \<\< Set Exclude Maximum( state=0\|1 )
...
### [Set Exclude Minimum](#set-exclude-minimum)[](#set-exclude-minimum "Click to copy url")

**Syntax:** obj \<\< Set Exclude Minimum( state=0\|1 )
...
**Syntax:** obj \<\< Set Format( "format", \<width, \<decimal places\>\>, \<"Use thousands separator"\> )

**Description:** Set the format of the number to display.

``` jsl
dt = Open( "$SAMPLE_DATA/Big Class.jmp" );
biv = dt << Bivariate( Y( :weight ), X( :height ), Kernel Smoother( 1, 1, 0.5, 0 ) );
rbiv = biv << report;
fontobj = numbox = rbiv[NumberBox( 1 )];
numbox << Set Format( Format( Fixed, 7, 3 ) );
```
...
**Description:** Sets the given function for the control. The function's script runs when the change to the Number Edit Box is committed.
...
New Window( "Example",
    Number Edit Box(
        ...
        10,
        <<SetFunction(
            Function( {thisBox}, /* put my value into my sibling's display */(thisBox << sib)
                 << settext( thisBox << getText )
            )
        )
    ),
    Text Box( "" )/* here's the sibling box, waiting to show the pw */
...
### [Set Increment](#set-increment)[](#set-increment "Click to copy url")

**Syntax:** obj \<\< Set Increment( inc )

**Description:** Sets the increment value to be used for stepping control. This value will be used when the up/down keys are pressed during editing or when the \<\<Increment or \<\<Decrement messages are sent.
...
### [Set Integer Only](#set-integer-only)[](#set-integer-only "Click to copy url")

**Syntax:** obj \<\< Set Integer Only( state=0\|1 )
...
### [Set Maximum](#set-maximum)[](#set-maximum "Click to copy url")

**Syntax:** obj \<\< Set Maximum( max )

**Description:** Sets the maximum value. A value of missing indicates that there is no maximum value.
...
### [Set Minimum](#set-minimum)[](#set-minimum "Click to copy url")

**Syntax:** obj \<\< Set Minimum( min )

**Description:** Sets the minimum value. A value of missing indicates that there is no minimum value.
...
### [Set Number Changed](#set-number-changed)[](#set-number-changed "Click to copy url")

**Syntax:** obj \<\< Set Number Changed( Function( {thisBox, value}, \<script\> ) )

**Description:** Sets the function that is executed each time a change is made to the number. This callback is called during editing before the change is committed. In the case of a canceled Edit operation, an additional callback is generated to provide the original value.
...
### [Set Show Spin Box](#set-show-spin-box)[](#set-show-spin-box "Click to copy url")

**Syntax:** obj \<\< Set Show Spin Box( state=0\|1 )

**Description:** Show a Spin Box to increment the value.
...
**Description:** Sets the tooltip of the Number Box.
...
**Description:** Sets the number edit box to be n characters wide.
...
[ Previous](NumberColEditBox.html "NumberColEditBox") [Next ](OutlineBox.html "OutlineBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/OutlineBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/OutlineBox.html)*

---

# [OutlineBox](#outlinebox)[](#outlinebox "Click to copy url")
...
**Description:** Returns a display box that groups other display boxes.
...
### [Add All Open Files](#add-all-open-files)[](#add-all-open-files "Click to copy url")

**Syntax:** obj \<\< Add All Open Files( \<Menu(0,1)\> )

**Description:** Brings up the menu to add all of the open files to the OutlineBox.
...
### [Add Context](#add-context)[](#add-context "Click to copy url")

**Syntax:** obj \<\< Add Context

**Description:** Key-Value pair for OutlineBoxes that adds a column for Make Combined Data Table command for TableBoxes

**JMP Version Added:** 16

### [Add Directory of Files](#add-directory-of-files)[](#add-directory-of-files "Click to copy url")

**Syntax:** obj \<\< Add Directory of Files

**Description:** Brings up the menu to add a directory of files to the OutlineBox.
...
### [Add File Reference](#add-file-reference)[](#add-file-reference "Click to copy url")

**Syntax:** obj \<\< Add File Reference

**Description:** Brings up the menu to add a file reference to the OutlineBox.
...
### [Add Open Files](#add-open-files)[](#add-open-files "Click to copy url")

**Syntax:** obj \<\< Add Open Files( \<Menu(0,1)\> )
...
### [Add Outline Item](#add-outline-item)[](#add-outline-item "Click to copy url")

**Syntax:** obj \<\< Add Outline Item

**Description:** Brings up the menu to add an outline item to the OutlineBox.
...
### [Add Script Button](#add-script-button)[](#add-script-button "Click to copy url")

**Syntax:** obj \<\< Add Script Button

**Description:** Brings up the menu to add a script button to the OutlineBox.
...
### [Add Text Item](#add-text-item)[](#add-text-item "Click to copy url")

**Syntax:** obj \<\< Add Text Item

**Description:** Brings up the menu to add text to the OutlineBox.
...
### [Add URL Reference](#add-url-reference)[](#add-url-reference "Click to copy url")

**Syntax:** obj \<\< Add URL Reference

**Description:** Brings up the menu to add a URL to the OutlineBox.
...
### [Add Window Reference](#add-window-reference)[](#add-window-reference "Click to copy url")

**Syntax:** obj \<\< Add Window Reference

**Description:** Brings up the menu to add a window reference to the OutlineBox.
...
**Syntax:** obj \<\< Close( bool )

**Description:** Closes the outline box.
...
### [Close All Below](#close-all-below)[](#close-all-below "Click to copy url")

**Syntax:** obj \<\< Close All Below

**Description:** Closes this Outline Box and all child Outline Boxes below this node.
...
### [Close All Like This](#close-all-like-this)[](#close-all-like-this "Click to copy url")
...
### [Close Where No Outlines](#close-where-no-outlines)[](#close-where-no-outlines "Click to copy url")

**Syntax:** obj \<\< Close Where No Outlines

**Description:** Closes all nodes that do not have children.
...
### [Edit Links](#edit-links)[](#edit-links "Click to copy url")

**Syntax:** obj \<\< Edit Links

**Description:** Finds all the file links in button scripts to edit them.

**JMP Version Added:** 16

### [Get Allow Title Wrapping](#get-allow-title-wrapping)[](#get-allow-title-wrapping "Click to copy url")

**Syntax:** 0\|1 = obj \<\< Get Allow Title Wrapping( state=0\|1 )

**Description:** Allows long titles to be wrapped
...
### [Get Close Orientation](#get-close-orientation)[](#get-close-orientation "Click to copy url")

**Syntax:** obj \<\< Get Close Orientation

**Description:** Returns setting for Outline Boxes to collapse vertically to save horizontal space.
...
### [Get Image Export Display](#get-image-export-display)[](#get-image-export-display "Click to copy url")

**Syntax:** obj \<\< Get Image Export Display

**Description:** Get the option for suppressing outline text when saving images
...
### [Get Menu Item State](#get-menu-item-state)[](#get-menu-item-state "Click to copy url")

**Syntax:** 0\|1\|-1 = obj \<\< Get Menu Item State( index )

**Description:** Gets the popup menu item state of index menu item. The state will be normal (0), checked (1), or disabled (-1)
...
### [Get Menu Script](#get-menu-script)[](#get-menu-script "Click to copy url")

**Syntax:** list = obj \<\< Get Menu Script

**Description:** Returns the menu script attached to the calling object.
...
### [Get Scriptable Object](#get-scriptable-object)[](#get-scriptable-object "Click to copy url")

**Syntax:** scriptable object = obj \<\< Get Scriptable Object

**Description:** Returns a reference to the scriptable object associated with the Outline Box.
...
### [Get Submenu](#get-submenu)[](#get-submenu "Click to copy url")

**Syntax:** obj \<\< Get Submenu( index )
...
**Syntax:** "string" = obj \<\< Get Title

**Description:** Gets the title of the outline box.
...
### [Get Title Background Color](#get-title-background-color)[](#get-title-background-color "Click to copy url")

**Syntax:** obj \<\< Title Background Color( color ); color = obj \<\< Get Title Background Color

**Description:** If the background color is set, the outline title is filled with the background color prior to drawing the title content. If the background color is set to "None", the background and content of the containing boxes show through.
...
### [Get Title Border](#get-title-border)[](#get-title-border "Click to copy url")

**Syntax:** obj \<\< Title Border( sides ); sides = obj \<\< Get Title Border

**Description:** Title borders are solid lines drawn around the outside of the outline title. If a single value is provided, it is applied to all sides. If two values are specified, they are applied to horizontal and vertical borders. Title borders are relative to the orientation of the title. An outline that is closed vertically rotates the border and the content.
...
### [Get Title Border Color](#get-title-border-color)[](#get-title-border-color "Click to copy url")

**Syntax:** obj \<\< Title Border Color( color ); color = obj \<\< Get Title Border Color

**Description:** Optional color to override the default color for outline title borders.
...
### [Get Title Padding](#get-title-padding)[](#get-title-padding "Click to copy url")

**Syntax:** obj \<\< Title Padding( sides ); sides = obj \<\< Get Title Padding

**Description:** Title padding adds space between the title content and the border of the title. If a single value is provided, it is applied to all sides. If two values are specified, they are applied to horizontal and vertical padding. Title padding is relative to the orientation of the title. An outline that is closed vertically rotates the padding and the content.
...
### [Get Title Text Color](#get-title-text-color)[](#get-title-text-color "Click to copy url")

**Syntax:** obj \<\< Title Text Color( color ); color = obj \<\< Get Title Text Color

**Description:** Outline title text is drawn using the given color if it has been set. If the property has not been set, the title inherits the text color of the containing box.
...
### [GetHorizontal](#gethorizontal)[](#gethorizontal "Click to copy url")

**Syntax:** obj \<\< GetHorizontal

**Description:** Returns 1 if the outline box's children are oriented horizontally or 0 if not.
...
### [GetOpen](#getopen)[](#getopen "Click to copy url")

**Syntax:** obj \<\< GetOpen

**Description:** Returns 1 if the outline box is open or 0 if closed.
...
**Syntax:** obj \<\< Horizontal( bool )

**Description:** Horizontally aligns the outline box's children.
...
### [Image Export Display](#image-export-display)[](#image-export-display "Click to copy url")

**Syntax:** obj \<\< Image Export Display( "Normal"\|"Text Only"\|"None" )

**Description:** Option for suppressing outline text when saving images
...
**Description:** If the Outline Box is part of a Journal, unlocks the Journal to allow further modification. Journals can be locked by right-clicking in the margin area.

**JMP Version Added:** 16

### [Lock Title](#lock-title)[](#lock-title "Click to copy url")

**Syntax:** obj \<\< Lock Title( state=0\|1 )

**Description:** Lock the outline title to prevent interactive changes.
...
### [Open All Below](#open-all-below)[](#open-all-below "Click to copy url")

**Syntax:** obj \<\< Open All Below

**Description:** Opens this Outline Box and all child Outline Boxes below this node.
...
### [Open All Like This](#open-all-like-this)[](#open-all-like-this "Click to copy url")

**Syntax:** obj \<\< Open All Like This

**Description:** Opens this Outline Box and all Outline Boxes in the display tree with the same original title or help key.
...
### [Set Allow Title Wrapping](#set-allow-title-wrapping)[](#set-allow-title-wrapping "Click to copy url")

**Syntax:** obj \<\< Set Allow Title Wrapping( 0\|1 )
...
### [Set Menu Item State](#set-menu-item-state)[](#set-menu-item-state "Click to copy url")

**Syntax:** obj \<\< Set Menu Item State( index, 0\|1\|-1 )

**Description:** Sets the popup menu item at index to be normal (0), checked (1), or disabled (-1)
...
### [Set Menu Script](#set-menu-script)[](#set-menu-script "Click to copy url")

**Syntax:** obj \<\< Set Menu Script( {"string",script,"string",script, ...} )

**Description:** Adds an entry to the menu when you click on the red triangle.
...
### [Set Scriptable Object](#set-scriptable-object)[](#set-scriptable-object "Click to copy url")

**Syntax:** obj \<\< Set Scriptable Object( \<scriptable object\> )

**Description:** Sets the scriptable object associated with the Outline Box. Outline Box will show a red triangle menu of messages that can be sent to the scriptable object. If no argument is provided, the scriptable object will be cleared.
...
### [Set Submenu](#set-submenu)[](#set-submenu "Click to copy url")

**Syntax:** obj \<\< Set Submenu( index, submenu count )
...
**Syntax:** obj \<\< Set Title( "string", \<Run Script(0 \| 1)\> )

**Description:** Changes the title of the outline box.
...
### [Set Title Changed](#set-title-changed)[](#set-title-changed "Click to copy url")

**Syntax:** obj \<\< Set Title Changed

**Description:** Set a script that runs when the outline title is changed.
...
### [SetHorizontal](#sethorizontal)[](#sethorizontal "Click to copy url")

**Syntax:** obj \<\< SetHorizontal( state=0\|1 )
...
### [SetOpen](#setopen)[](#setopen "Click to copy url")

**Syntax:** obj \<\< SetOpen( state=0\|1 )

**Description:** Opens or closes the outline.
...
### [Size to Fit](#size-to-fit)[](#size-to-fit "Click to copy url")

**Syntax:** obj \<\< Size to Fit

**Description:** Keep the window sized to fit the content.

**JMP Version Added:** 16

### [Title Background Color](#title-background-color)[](#title-background-color "Click to copy url")
...
### [Title Border](#title-border)[](#title-border "Click to copy url")
...
### [Title Border Color](#title-border-color)[](#title-border-color "Click to copy url")
...
### [Title Padding](#title-padding)[](#title-padding "Click to copy url")
...
[ Previous](NumberEditBox.html "NumberEditBox") [Next ](OverlayListBox.html "OverlayListBox")

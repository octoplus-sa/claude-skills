...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/PanelBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/PanelBox.html)*

---

# [PanelBox](#panelbox)[](#panelbox "Click to copy url")
...
**Description:** Returns a display box that has a title and contains other display boxes.

``` jsl
New Window( "Example", Panel Box( "A Panel Box", Text Box( "Text inside" ) ) );
```
...
**Description:** Returns the title of the PanelBox.

``` jsl
New Window( "Example", pb = Panel Box( "A Panel Box", Text Box( "Text inside" ) ) );
Print( pb << Get Title() );
```
...
**Description:** Sets the title of the PanelBox.

``` jsl
New Window( "Example", pb = Panel Box( "A Panel Box", Text Box( "Text inside" ) ) );
pb << Set Title( "A New Title" );
```
...
[ Previous](PageBreakBox.html "PageBreakBox") [Next ](ParallelScaleBox.html "ParallelScaleBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/PictBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/PictBox.html)*

---

# [PictBox](#pictbox)[](#pictbox "Click to copy url")
...
**Description:** Returns a display box that contains an image.
...
**Description:** Flips the image in both a vertical and horizontal direction.
...
**Description:** Flips the image in a horizontal direction.
...
**Description:** Flips the image in a vertical direction.
...
**Description:** Get the image contained by the box.

``` jsl
New Window( "Example", pb = Picture Box( Open( "$SAMPLE_IMAGES/tile.jpg", jpg ) ) );
image = pb << Get Image();
Print( image << Get Size() );
```
...
### [Set Image](#set-image)[](#set-image "Click to copy url")

**Syntax:** obj \<\< Set Image( image )

**Description:** Set the image contained by the box

``` jsl
New Window( "Example", pb = Picture Box( Open( "$SAMPLE_IMAGES/tile.jpg", jpg ) ) );
Wait( 2 );
pb << Set Image( Open( "$SAMPLE_IMAGES/tile.jpg", jpg ) );
```
...
[ Previous](ParallelScaleBox.html "ParallelScaleBox") [Next ](PictSeg.html "PictSeg")

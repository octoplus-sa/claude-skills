...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/PlotColBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/PlotColBox.html)*

---

# [PlotColBox](#plotcolbox)[](#plotcolbox "Click to copy url")
...
**Description:** Returns a display box labeled with string as the title to graph the numbers.
...
**Syntax:** obj \<\< Set Values( matrix\|list )

**Description:** Updates the PlotColBox to the values provided.
...
**Syntax:** obj \<\< Significance( list\|matrix )
...
[ Previous](PlatformContainerBox.html "PlatformContainerBox") [Next ](PolySeg.html "PolySeg")

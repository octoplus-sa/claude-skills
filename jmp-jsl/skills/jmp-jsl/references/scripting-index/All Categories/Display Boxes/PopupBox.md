...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/PopupBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/PopupBox.html)*

---

# [PopupBox](#popupbox)[](#popupbox "Click to copy url")
...
**Description:** Sets the given function for the control. The function's script runs when a new item is selected from the Popup Box.
    ...
    Popup Box(
        ...
        <<SetFunction(
            Function( {thisBox, index},
                (thisBox << sib) << settext( Char( index ) )
            )
        )
    ),
    Text Box( "" )
...
[ Previous](PolySeg.html "PolySeg") [Next ](Project.html "Project")

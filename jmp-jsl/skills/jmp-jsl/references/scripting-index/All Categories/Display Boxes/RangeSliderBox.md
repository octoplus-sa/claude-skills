...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/RangeSliderBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/RangeSliderBox.html)*

---

# [RangeSliderBox](#rangesliderbox)[](#rangesliderbox "Click to copy url")
...
### [Get Lower](#get-lower)[](#get-lower "Click to copy url")

**Syntax:** float = obj \<\< Get Lower( \<index\> )

**Description:** Returns the floating-point value the slider is currently set to.
...
### [Get Lower Var](#get-lower-var)[](#get-lower-var "Click to copy url")

**Syntax:** string = obj \<\< Get Lower Var

**Description:** Returns the variable name associated with the slider.
...
Print( sb << Get Lower Var );
```

### [Get Max](#get-max)[](#get-max "Click to copy url")

**Syntax:** float = obj \<\< Get Max( \<index\> )

**Description:** Returns the maximum value the slider can be set to.
...
**Syntax:** float = obj \<\< Get Min( \<index\> )

**Description:** Returns the minimum value the slider can be set to.
...
### [Get N](#get-n)[](#get-n "Click to copy url")

**Syntax:** float = obj \<\< Get N

**Description:** Returns the number of sliders that are in the SliderBox.
...
### [Get Upper](#get-upper)[](#get-upper "Click to copy url")

**Syntax:** float = obj \<\< Get Upper( \<index\> )
...
### [Get Upper Var](#get-upper-var)[](#get-upper-var "Click to copy url")

**Syntax:** string = obj \<\< Get Upper Var
...
**Description:** Gets the width of the slider.
...
### [Rescale Slider](#rescale-slider)[](#rescale-slider "Click to copy url")

**Syntax:** obj \<\< Rescale Slider( min,max )

**Description:** Sets the minimum and maximum values the slider should accept
...
**Description:** Sets the given function for the control. The function's script runs when the value of either slider changes.
...
New Window( "Example",
    Panel Box( "Range Slider",
        sb = Range Slider Box( 0, 1, sliderLowerValue, sliderUpperValue, ),
        Lineup Box( N Col( 2 ),
            Text Box( "Lower Value: " ),
            Text Box( sliderLowerValue ),
            Text Box( "Upper Value: " ),
            Text Box( sliderUpperValue )
        )
    )
);
sb << Set Function(
    Function( {thisBox},
        {lowertb = (((thisBox << sib) << child) << sib)},
        lowertb << Set Text( Char( thisBox << Get Lower ) );
        (((lowertb) << sib) << sib) << Set Text( Char( thisBox << Get Upper ) );
    )
);
```

### [Set Lower](#set-lower)[](#set-lower "Click to copy url")

**Syntax:** obj \<\< Set Lower( float, \<index\>, \<run script(0\|1)\> )

**Description:** Sets the floating point value of the slider.
...
sb << Set Lower( 0.4, 1, run script( 1 ) );
```

### [Set Lower Var](#set-lower-var)[](#set-lower-var "Click to copy url")

**Syntax:** string = obj \<\< Set Lower Var

**Description:** Sets the variable name associated with the slider.
...
Print( sb << Set Lower Var( mySliderVar ) );
```

### [Set Max](#set-max)[](#set-max "Click to copy url")

**Syntax:** obj \<\< Set Max( float, \<index\> )

**Description:** Set the maximum value the slider can be set to.
...
Print( sb << Set Max( 2.0 ) );
```

### [Set Min](#set-min)[](#set-min "Click to copy url")

**Syntax:** obj \<\< Set Min( float, \<index\> )

**Description:** Set the minimum value the slider can be set to.
...
### [Set Upper](#set-upper)[](#set-upper "Click to copy url")

**Syntax:** obj \<\< Set Upper( float, \<index\>, \<run script(0\|1)\> )
...
sb << Set Upper( 0.8, 1, run script( 1 ) );
```

### [Set Upper Var](#set-upper-var)[](#set-upper-var "Click to copy url")

**Syntax:** string = obj \<\< Set Upper Var
...
Print( sb << Set Upper Var( mySliderVar ) );
```
...
[ Previous](RangeSeg.html "RangeSeg") [Next ](ScaleBox.html "ScaleBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/ScriptBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/ScriptBox.html)*

---

# [ScriptBox](#scriptbox)[](#scriptbox "Click to copy url")
...
**Description:** Returns a display box that contains an editable scripting box.

#### [JSL](#jsl)[](#jsl "Click to copy url")

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
```
...
sb = Script Box( pyscript, "Python", 300, 100 );
New Window( "This is a python script box", sb );
```

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Append Text](#append-text)[](#append-text "Click to copy url")

**Syntax:** obj \<\< Append Text( text )

**Description:** Add the given text to the end of the script.

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Append Text( "print(\!" World\!");" );
```

### [Collapse All](#collapse-all)[](#collapse-all "Click to copy url")

**Syntax:** obj \<\< Collapse All

**Description:** Collapses all foldable sections of the contents of the Script Box.
...
### [Expand All](#expand-all)[](#expand-all "Click to copy url")

**Syntax:** obj \<\< Expand All

**Description:** Expands all collapsed sections of the contents of the Script Box.
...
### [Get Cursor Line](#get-cursor-line)[](#get-cursor-line "Click to copy url")

**Syntax:** obj \<\< Get Cursor Line

**Description:** Returns the line the cursor is currently in.
...
### [Get Cursor Position](#get-cursor-position)[](#get-cursor-position "Click to copy url")

**Syntax:** obj \<\< Get Cursor Position
...
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Get Cursor Position;
```

### [Get Line Count](#get-line-count)[](#get-line-count "Click to copy url")

**Syntax:** obj \<\< Get Line Count

**Description:** Returns the line count of the Script Box.

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
Print( sb << Get Line Count );
```

### [Get Line Text](#get-line-text)[](#get-line-text "Click to copy url")

**Syntax:** obj \<\< Get Line Text( line number )

**Description:** Returns the text at the given line number.
...
**Syntax:** obj \<\< Get Lines

**Description:** Returns all the text in the script window as a list of strings, one line per string.
...
### [Get Selection Width](#get-selection-width)[](#get-selection-width "Click to copy url")

**Syntax:** obj \<\< Get Selection Width

**Description:** Returns the current width of the selection.

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Get Selection Width;
```

### [Get Show Empty Scrollbars](#get-show-empty-scrollbars)[](#get-show-empty-scrollbars "Click to copy url")

**Syntax:** obj \<\< Get Show Empty Scrollbars( state=0\|1 )

**Description:** Returns a Boolean value that indicates whether the horizontal and vertical scrollbars are shown even if they are unnecessary

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Get Show Empty Scrollbars();
```

### [Get Show Scrollbars](#get-show-scrollbars)[](#get-show-scrollbars "Click to copy url")

**Syntax:** obj \<\< Get Show Scrollbars

**Description:** Returns a two element list indicating whether the horizontal and vertical scrollbars are shown

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Get Show Scrollbars();
```

### [Read Only](#read-only)[](#read-only "Click to copy url")

**Syntax:** obj \<\< Read Only( state=0\|1 )

**Description:** If true (1), the text within the Script Box cannot be modified.
...
**Description:** Formats the script to make it easier to read.
...
**Description:** Evaluates the script.
...
### [Set Cursor Position](#set-cursor-position)[](#set-cursor-position "Click to copy url")

**Syntax:** obj \<\< Set Cursor Position( position )

**Description:** Sets the cursor position to the provided position.

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Set Cursor Position( 5 );
```

### [Set Line Text](#set-line-text)[](#set-line-text "Click to copy url")

**Syntax:** obj \<\< Set Line Text( line number, text )

**Description:** Sets the text at the given line number.
...
sb << Reformat;
sb << Set Line Text( 2, "print(\!"Goodbye\!");" );
```

### [Set Selection Width](#set-selection-width)[](#set-selection-width "Click to copy url")

**Syntax:** obj \<\< Set Selection Width( width )

**Description:** Sets the width of the selection to the provided width.

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Set Selection Width( 10 );
```

### [Set Show Empty Scrollbars](#set-show-empty-scrollbars)[](#set-show-empty-scrollbars "Click to copy url")

**Syntax:** obj \<\< Set Show Empty Scrollbars( state=0\|1 )

**Description:** If true (1), then the horizontal or vertical scrollbars are shown even if they are unnecessary

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Set Show Empty Scrollbars( 1 );
```

### [Set Show Scrollbars](#set-show-scrollbars)[](#set-show-scrollbars "Click to copy url")

**Syntax:** obj \<\< Set Show Scrollbars( state=0\|1 )

**Description:** Specifies whether the horizontal and vertical scrollbars are shown

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Set Show Scrollbars( 0, 0 );
```
...
**Description:** Replaces the current text in the Script Box to the given text.

``` jsl
sb = Script Box( "print(\!" Hello\!");", 300, 100 );
New Window( "This is a script box", sb );
sb << Set Text( "print(\!"Hello World\!");" );
```
...
**Description:** Enable/disable the embedded log.

``` jsl
script = Open( "$SAMPLE_SCRIPTS/Prime Numbers.jsl" );
sb = Get Window( "Prime Numbers" )[Script Box( 1 )];
sb << Show Embedded Log( 1 );
```

### [Show Line Numbers](#show-line-numbers)[](#show-line-numbers "Click to copy url")

**Syntax:** obj \<\< Show Line Numbers( state=0\|1 )

**Description:** Shows and hides the line numbers on the left side of the script box
...
[ Previous](SceneBox.html "SceneBox") [Next ](ScriptContainerBox.html "ScriptContainerBox")

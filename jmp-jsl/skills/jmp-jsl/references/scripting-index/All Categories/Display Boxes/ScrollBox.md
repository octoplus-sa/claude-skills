...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/ScrollBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/ScrollBox.html)*

---

# [ScrollBox](#scrollbox)[](#scrollbox "Click to copy url")
...
**Description:** Returns a display box that places a scroll bar on the bottom and right if the contents are bigger than the size of the ScrollBox.

``` jsl
dt = Open( "$SAMPLE_DATA/Car Poll.jmp" );
win = New Window( "Report window",
    Outline Box( "Report",
        H List Box(
            dt << New Data Box,
            sb = H Scroll Box(
...
win << Set Window Size( 1100, 700 );
```

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Get Auto Scrollable](#get-auto-scrollable)[](#get-auto-scrollable "Click to copy url")

**Syntax:** obj \<\< Get Auto Scrollable

**Description:** Returns the Auto Scrollable setting.
...
sb << Get Auto Scrollable();
```

### [Get Clip Printing](#get-clip-printing)[](#get-clip-printing "Click to copy url")

**Syntax:** obj \<\< Get Clip Printing( state=0\|1 )

**Description:** Returns the current setting for clipping the scroll box content when printing.
...
New Window( "Print Me!",
    s = Scroll Box(
        V List Box(
            Overlay Plot( X( :weight ), Y( :height ), By( :age ) ),
            Overlay Plot( X( :weight ), Y( :height ), By( :Sex ) )
        )
    )
);
Show( s << Get Clip Printing );
```
...
**Syntax:** pixels = obj \<\< Get Height

**Description:** Returns the height of the scroll area.

### [Get Scroll Extents](#get-scroll-extents)[](#get-scroll-extents "Click to copy url")

**Syntax:** {h pixels,v pixels} = obj \<\< Get Scroll Extents

**Description:** Returns the maximum positions for horizontal and vertical scrolling.
...
win << Set Window Size( 1000, 700 );
sb << Get Scroll Extents();
```

### [Get Scroll Position](#get-scroll-position)[](#get-scroll-position "Click to copy url")

**Syntax:** {h,v} = obj \<\< Get Scroll Position

**Description:** Returns the current horizontal and vertical scroll positions.
...
sb << Get Scroll Position();
```

### [Get Scrollers](#get-scrollers)[](#get-scrollers "Click to copy url")

**Syntax:** {h,v} = obj \<\< Get Scrollers

**Description:** Returns the flags for horizontal and vertical scrolling. If scrolling is disabled in a given direction, the Scroll Box will behave as a regular container in that direction.
...
win << Set Window Size( 1000, 700 );
sb << Set Scrollers( 0, 1 );
sb << Get Scrollers();
```

### [Get Show Empty](#get-show-empty)[](#get-show-empty "Click to copy url")

**Syntax:** obj \<\< Get Show Empty

**Description:** Returns the current setting for showing scroll bars when they are empty.
...
**Description:** Returns the width of the scroll area.

### [Height](#height)[](#height "Click to copy url")

**Syntax:** obj \<\< Height( pixels )

**Description:** Sets the height of the scroll area.
...
### [Set Auto Scrollable](#set-auto-scrollable)[](#set-auto-scrollable "Click to copy url")

**Syntax:** obj \<\< Set Auto Scrollable( state=0\|1 )

**Description:** Automatically set scrolling parameters based on stretching properties of the child box. The scroll bar in each direction will be active if the box is not stretchable in that direction.
...
**Description:** Sets the background of the Scroll Box to the given color.
...
win << Set Window Size( 1000, 700 );
sb << Set Background Color( "Red" );
```

### [Set Clip Printing](#set-clip-printing)[](#set-clip-printing "Click to copy url")

**Syntax:** obj \<\< Set Clip Printing( state=0\|1 )

**Description:** The scroll box content is clipped to the scroll box size when printed, or the entire content is displayed. Clipping is off by default.
...
### [Set Scroll Position](#set-scroll-position)[](#set-scroll-position "Click to copy url")

**Syntax:** obj \<\< Set Scroll Position( h,v )

**Description:** Sets the horizontal and vertical scroll positions. Values can be given in pixels, or using the keywords "Start" and "End".
...
sb << Set Scroll Position( 0, 200 );
Wait( 1 );
// scroll to lower-right corner
sb << Set Scroll Position( "End", "End" );
Wait( 1 );
// scroll to upper-left corner
sb << Set Scroll Position( "Start", "Start" );
```

### [Set Scrollers](#set-scrollers)[](#set-scrollers "Click to copy url")

**Syntax:** obj \<\< Set Scrollers( h,v )

**Description:** Sets the flags for horizontal and vertical scrolling. If scrolling is disabled in a given direction, the Scroll Box will behave as a regular container in that direction.
...
### [Set Show Empty](#set-show-empty)[](#set-show-empty "Click to copy url")

**Syntax:** obj \<\< Set Show Empty( state=0\|1 )

**Description:** Show the scroll bars even if they are empty.
...
**Description:** Sets the width of the scroll area.
...
[ Previous](ScriptableContainerBox.html "ScriptableContainerBox") [Next ](ShapeBorderBox.html "ShapeBorderBox")

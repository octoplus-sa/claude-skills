...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/SheetBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/SheetBox.html)*

---

# [SheetBox](#sheetbox)[](#sheetbox "Click to copy url")
...
**Description:** Returns a display box that can organize other display boxes horizontally or vertically.
...
New Window( "Example",
    V Sheet Box(
        ...
        H Sheet Box(
            ...
            Sheet Part( "", Excerpt Box( 2, {Picture Box( 1 )} ) )
        ),
        H Sheet Box(
            Sheet Part( "", Excerpt Box( 3, {Picture Box( 1 )} ) ),
            Sheet Part( "", Excerpt Box( 4, {Picture Box( 1 )} ) )
        )
    )
);
```
...
### [Hold](#hold)[](#hold "Click to copy url")

**Syntax:** obj \<\< Hold( element )

**Description:** Specifies what element the SheetBox should hold.
...
**Description:** Sets the width if the SheetBox is horizontal, otherwise it sets the height.
...
**Syntax:** obj \<\< Sizes( {width,height} )

**Description:** Sets the width and height of the SheetBox.
...
[ Previous](ShapeSeg.html "ShapeSeg") [Next ](SheetPanelBox.html "SheetPanelBox")

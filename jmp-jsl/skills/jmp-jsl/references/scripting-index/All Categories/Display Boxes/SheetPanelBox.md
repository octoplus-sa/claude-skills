...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/SheetPanelBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/SheetPanelBox.html)*

---

# [SheetPanelBox](#sheetpanelbox)[](#sheetpanelbox "Click to copy url")
...
**Description:** A sheet part specifies if the SheetBox should be horizontal or vertical.
...
New Window( "Example",
    V Sheet Box(
        ...
        H Sheet Box(
            sp = Sheet Part( "", Excerpt Box( 1, {Picture Box( 1 )} ) ),
...
**Description:** Sets the title of the Sheet Part.
...
[ Previous](SheetBox.html "SheetBox") [Next ](SliderBox.html "SliderBox")

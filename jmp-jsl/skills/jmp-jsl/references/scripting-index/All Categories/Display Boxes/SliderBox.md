...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/SliderBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/SliderBox.html)*

---

# [SliderBox](#sliderbox)[](#sliderbox "Click to copy url")
...
### [Get Log Scale](#get-log-scale)[](#get-log-scale "Click to copy url")

**Syntax:** bool = obj \<\< Get Log Scale

**Description:** Returns if the slider is in a log scale (1) or linear scale (0)
...
sb << Rescale Slider( 1, 100 );
sb << Set Log Scale( 1 );
Print( sb << Get Log Scale );
```
...
### [Get Var](#get-var)[](#get-var "Click to copy url")

**Syntax:** string = obj \<\< Get Var
...
**Syntax:** obj \<\< Set( float, \<index\>,\<run script(0\|1)\> )
...
**Description:** Sets the given function for the control. The function's script runs when the slider changes.
...
New Window( "Example",
    Panel Box( "Slider",
        ...
        Lineup Box( N Col( 2 ), Text Box( "Slider Value: " ), Text Box( sliderValue ) )
    )
);
sb << Set Function(
    Function( {thisBox},
...
### [Set Log Scale](#set-log-scale)[](#set-log-scale "Click to copy url")

**Syntax:** obj \<\< Set Log Scale( 0\|1 )

**Description:** Sets the slider to a log scale (1) or linear scale (0)
...
### [Set Var](#set-var)[](#set-var "Click to copy url")

**Syntax:** string = obj \<\< Set Var
...
[ Previous](SheetPanelBox.html "SheetPanelBox") [Next ](SpacerBox.html "SpacerBox")

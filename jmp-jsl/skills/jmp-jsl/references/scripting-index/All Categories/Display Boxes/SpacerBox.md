...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/SpacerBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/SpacerBox.html)*

---

# [SpacerBox](#spacerbox)[](#spacerbox "Click to copy url")
...
**Description:** Returns a display box which can be given an arbitrary size and color.
...
**Description:** Sets the spacer's color to the given color
...
**Description:** Returns the color of the spacer.
...
**Syntax:** boolean = obj \<\< Get Fill

**Description:** Returns whether the background is painted or not.
...
**Description:** Returns the height of the spacer.
...
**Syntax:** alpha = obj \<\< Get Transparency

**Description:** Returns the transparency value, 0..1.
...
**Description:** Returns the width of the spacer.
...
**Description:** Sets the height of the spacer.
...
**Description:** Sets whether the background is painted or not.
...
/*make the red spacer flash by setting the fill status to the opposite value several times*/
For( i = 1, i <= 14, i++,
    sb2 << Set Fill( !(sb2 << Get Fill()) );
    Wait( .2 );
);
```
...
**Syntax:** obj \<\< Size( width, height,\<min width, min height\>,\<max width, max height\> )

**Description:** Sets the width and height of the spacer.
...
**Syntax:** obj \<\< Transparency( alpha )

**Description:** Sets the transparency value, 0..1.
...
**Description:** Sets the width of the spacer.
...
[ Previous](SliderBox.html "SliderBox") [Next ](SpinBox.html "SpinBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/SplitterBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/SplitterBox.html)*

---

# [SplitterBox](#splitterbox)[](#splitterbox "Click to copy url")
...
### [Close Panel](#close-panel)[](#close-panel "Click to copy url")

**Syntax:** obj \<\< Close Panel( index,\<previous\> )

**Description:** Close the panel at the given index. If the previous argument is 1 the space will be allocated to the previous box in the list, otherwise it will be allocated to the next box.
...
### [Divider Color](#divider-color)[](#divider-color "Click to copy url")

**Syntax:** obj \<\< Divider Color( color ); color = obj \<\< Get Divider Color

**Description:** Specifies or returns the color for each split divider. If unset, a color based on the background color is used.
...
box << Divider Color( "Red" );
Show( box << Get Divider Color );
```

### [Divider Length](#divider-length)[](#divider-length "Click to copy url")

**Syntax:** obj \<\< Divider Length( number ); number = obj \<\< Get Divider Length

**Description:** Specifies or returns the length as a percentage for each split divider. A value of 0.0 results in an invisible divider. A value of 1.0 results in the (default) full length divider line.
...
box << Divider Length( 0.8 );
Show( box << Get Divider Length );
```

### [Divider Thickness](#divider-thickness)[](#divider-thickness "Click to copy url")

**Syntax:** obj \<\< Divider Thickness( number ); number = obj \<\< Get Divider Thickness

**Description:** Specifies or returns the line thickness for each split divider. This value must be non-zero.
...
box << Divider Thickness( 10 );
Show( box << Get Divider Thickness );
```
...
### [Get Divider Color](#get-divider-color)[](#get-divider-color "Click to copy url")
...
### [Get Divider Length](#get-divider-length)[](#get-divider-length "Click to copy url")
...
### [Get Divider Thickness](#get-divider-thickness)[](#get-divider-thickness "Click to copy url")
...
**Syntax:** {size1,...} = obj \<\< Get Sizes

**Description:** Returns the proportions for each panel of the Splitter Box.
...
### [Open Panel](#open-panel)[](#open-panel "Click to copy url")

**Syntax:** obj \<\< Open Panel( index,\<previous\> )

**Description:** Open the panel at the given index. If the previous argument is 1 the space will be taken from the previous box in the list, otherwise it will be taken from the next box.
...
### [Set Sizes](#set-sizes)[](#set-sizes "Click to copy url")

**Syntax:** obj \<\< Set Sizes( {size1,...} )

**Description:** Sets the proportions for each panel of the Splitter Box.
...
box << Set Sizes( {0.6, 0.4} );
```

### [Size](#size)[](#size "Click to copy url")

**Syntax:** obj \<\< Size( size )

**Description:** Sets the proportion for the last panel of the Splitter Box.
...
### [get horizontal](#get-horizontal)[](#get-horizontal "Click to copy url")

**Syntax:** state=0\|1 = obj \<\< get horizontal

**Description:** Returns if the List Box is horizontal (1) or vertical (0).

``` jsl
New Window( "Example",
    Outline Box( "Outline Box",
        vlb = V List Box(
            hlb = H List Box( Text Edit Box( "Top Left" ), Text Edit Box( "Top Right" ) ),
            H List Box( Text Edit Box( "Bottom Left" ), Text Edit Box( "Bottom Right" ) )
        )
    )
);
Print( "Vertical List Box:", vlb << Get Horizontal );
Print( "Horizontal List Box:", hlb << Get Horizontal );
```

### [set horizontal](#set-horizontal)[](#set-horizontal "Click to copy url")

**Syntax:** obj \<\< set horizontal( state=0\|1 )

**Description:** Sets the List Box to horizontal (1) or vertical (0).
...
[ Previous](SpinBox.html "SpinBox") [Next ](StemLeafBox.html "StemLeafBox")

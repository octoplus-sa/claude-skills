...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/StringColBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/StringColBox.html)*

---

# [StringColBox](#stringcolbox)[](#stringcolbox "Click to copy url")
...
**Description:** Returns a display box that displays strings in a column.

``` jsl
New Window( "Example",
    col = String Col Box( "Strings",
...
**Syntax:** "left"\|"right"\|"center" = obj \<\< Get Justify

**Description:** Gets the horizontal justification for the column
...
### [Numerical Order](#numerical-order)[](#numerical-order "Click to copy url")

**Syntax:** obj \<\< Numerical Order( \<0 \| 1\> )

**Description:** Text containing numbers will be sorted in numerical order.
...
New Window( "Mountains",
    Text Box( "Numerical order = 0", <<Margin( 5, 5, 5, 10 ) ),
    Table Box(
        String Col Box( "Mountain", {"K2", "Delphi", "Kilimanjaro", "Grand Teton"} ),
        sb1 = String Col Box( "Elevation (meters)", {"8611", "681", "5895", "4199"} ),
        <<sort by column( 2, 1 )
    ),
    Text Box( "Numerical order = 1", <<Margin( 5, 20, 5, 10 ) ),
    Table Box(
        String Col Box( "Mountain", {"K2", "Delphi", "Kilimanjaro", "Grand Teton"} ),
        sb2 = String Col Box( "Elevation (meters)", {"8611", "681", "5895", "4199"} ),
        <<sort by column( 2, 1 )
    )
);
sb1 << numerical order( 0 );
sb2 << numerical order( 1 );
```
...
### [Set Allow Text Search](#set-allow-text-search)[](#set-allow-text-search "Click to copy url")

**Syntax:** obj \<\< Set Allow Text Search( \<0 \| 1\> )

**Description:** In table boxes with selectable rows, this command allows a string column that has focus to respond to keyboard input to change the selected row.
...
### [Set Justify](#set-justify)[](#set-justify "Click to copy url")

**Syntax:** obj \<\< Set Justify( "left","right","center" )

**Description:** Sets the horizontal justification for the column
...
[ Previous](StickyListBox.html "StickyListBox") [Next ](StringColEditBox.html "StringColEditBox")

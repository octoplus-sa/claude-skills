...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/TabListBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/TabListBox.html)*

---

# [TabListBox](#tablistbox)[](#tablistbox "Click to copy url")
...
**Description:** Returns a display box that has pages containing other display boxes.
...
**Syntax:** obj \<\< Add(\<index\>,"title",contents); obj \<\< Add(\<index\>,tabPageBox)

**Description:** Adds a new tab. If no index is specified, the tab is appended after the current tabs. If the content to be added is not a Tab Page Box, then a new Tab Page Box will be added to hold the content.
...
**Syntax:** obj \<\< Delete( \<index\> )

**Description:** Removes the tab at index. If no index is specified, the selected tab is removed.
...
### [DockName](#dockname)[](#dockname "Click to copy url")

**Syntax:** obj \<\< DockName( text )

### [Dockable](#dockable)[](#dockable "Click to copy url")

**Syntax:** obj \<\< Dockable( bool )

**Description:** If a container is dockable, children that are moveable can be rearranged using drag-and-drop.
...
### [Get DockName](#get-dockname)[](#get-dockname "Click to copy url")

**Syntax:** obj \<\< Get DockName

### [Get Dockable](#get-dockable)[](#get-dockable "Click to copy url")

**Syntax:** bool = obj \<\< Get Dockable

**Description:** Return the dockable setting for the container box.
...
### [Get Min Title Width](#get-min-title-width)[](#get-min-title-width "Click to copy url")

**Syntax:** obj \<\< Get Min Title Width

**Description:** Get the minimum width of the truncated tab titles when Overflow Enabled is set. The default setting of 0 will apply a default minimum width.
...
### [Get Overflow Enabled](#get-overflow-enabled)[](#get-overflow-enabled "Click to copy url")

**Syntax:** obj \<\< Get Overflow Enabled

**Description:** When Overflow Enabled is 1, the tab list will not be forced to the width of the tab titles. If the tab list is not wide enough for all titles, an overflow menu will be shown to allow selection of a new tab.
...
### [Get Show Tabs](#get-show-tabs)[](#get-show-tabs "Click to copy url")

**Syntax:** obj \<\< Get Show Tabs

**Description:** Get the current status of the Tab visibility
...
**Syntax:** style = obj \<\< Get Style

**Description:** Get the current visual appearance of the tab control.
...
### [Get Tab Changed](#get-tab-changed)[](#get-tab-changed "Click to copy url")

**Syntax:** obj \<\< Get Tab Changed

**Description:** Returns the script that is run when a different tab is selected.
...
### [Get Tab Close](#get-tab-close)[](#get-tab-close "Click to copy url")

**Syntax:** obj \<\< Get Tab Close

**Description:** Returns the script that is run when a tab is closed from a script or through the close icon. The script should return 1 to allow the close, or 0 to cancel the close.
...
### [Get Tab Close Tip](#get-tab-close-tip)[](#get-tab-close-tip "Click to copy url")

**Syntax:** "string" = obj \<\< Get Tab Close Tip

**Description:** Returns the tooltip of the Close Tab icon.
...
### [Get Tab Count](#get-tab-count)[](#get-tab-count "Click to copy url")

**Syntax:** count = obj \<\< Get Tab Count
...
### [Get Tab Margin](#get-tab-margin)[](#get-tab-margin "Click to copy url")

**Syntax:** all \| horizontal,vertical \| left,top,right,bottom = obj \<\< Get Tab Margin

**Description:** Returns the margin of the tabs.
...
### [Get Tab New](#get-tab-new)[](#get-tab-new "Click to copy url")

**Syntax:** obj \<\< Get Tab New

**Description:** Returns the script that is run when the New tab is clicked. The script is responsible for creating the new tab.
...
### [Get Tab New Icon](#get-tab-new-icon)[](#get-tab-new-icon "Click to copy url")

**Syntax:** "string" = obj \<\< Get Tab New Icon

**Description:** Returns the icon of the New tab.
...
### [Get Tab New Tip](#get-tab-new-tip)[](#get-tab-new-tip "Click to copy url")

**Syntax:** "string" = obj \<\< Get Tab New Tip

**Description:** Returns the tooltip of the New tab.
...
### [Get Title Location](#get-title-location)[](#get-title-location "Click to copy url")

**Syntax:** style = obj \<\< Get Title Location

**Description:** Get the current title location setting.
...
### [Index of Tab](#index-of-tab)[](#index-of-tab "Click to copy url")

**Syntax:** index = obj \<\< Index of Tab( "string" )

**Description:** Returns the index of the tab with the specified title.
...
**Syntax:** obj \<\< Insert(\<index\>,"title",contents); obj \<\< Insert(\<index\>,tabPageBox)

**Description:** Inserts a new tab. If no index is specified, the new tab is appended after the current tabs. If the content to be added is not a Tab Page Box, then a new Tab Page Box will be added to hold the content.
...
### [Move Tab](#move-tab)[](#move-tab "Click to copy url")

**Syntax:** obj \<\< Move Tab( fromIndex, toIndex )

**Description:** Move the tab at position fromIndex to position toIndex.
...
**Syntax:** obj \<\< Replace(\<index\>,"title",contents); obj \<\< Replace(\<index\>,tabPageBox)

**Description:** Replaces the tab. If no index is specified, the selected tab is replaced. If the content to be added is not a Tab Page Box, then a new Tab Page Box will be added to hold the content.
...
### [Set Min Title Width](#set-min-title-width)[](#set-min-title-width "Click to copy url")

**Syntax:** obj \<\< Set Min Title Width( number )

**Description:** Set the minimum width of the truncated tab titles when Overflow Enabled is set. The default setting of 0 will apply a default minimum width.
...
### [Set Overflow Enabled](#set-overflow-enabled)[](#set-overflow-enabled "Click to copy url")

**Syntax:** obj \<\< Set Overflow Enabled( state=0\|1 )

**Description:** When Overflow Enabled is true, the tab list will not be forced to the width of the tab titles. If the tab list is not wide enough for all titles, an overflow menu will be shown to allow selection of a new tab. This option only applies if the style is set to Tab.
...
**Syntax:** obj \<\< Set Selected( index )

**Description:** Brings focus to the tab at index.
...
### [Set Style](#set-style)[](#set-style "Click to copy url")

**Syntax:** obj \<\< Set Style( "Tab"\|"Combo"\|"Outline"\|"Vertical Spread"\|"Horizontal Spread"\|"Minimize Size" )

**Description:** Changes the visual appearance of the tab control.
...
### [Set Tab Changed](#set-tab-changed)[](#set-tab-changed "Click to copy url")

**Syntax:** obj \<\< Set Tab Changed( script\|Function( {this}, \<script\> ) )

**Description:** After a change is made (such as a new tab selection), the specified script or function is run.
...
### [Set Tab Close](#set-tab-close)[](#set-tab-close "Click to copy url")

**Syntax:** obj \<\< Set Tab Close( script\|Function )

**Description:** Set the script or Function to run when a tab is closed from a script or through the close icon. The script or Function should return 1 to allow the close, or 0 to cancel the close.
...
### [Set Tab Close Tip](#set-tab-close-tip)[](#set-tab-close-tip "Click to copy url")

**Syntax:** obj \<\< Set Tab Close Tip( "string" )

**Description:** Sets the tooltip of the Close Tab icon.
...
### [Set Tab Margin](#set-tab-margin)[](#set-tab-margin "Click to copy url")

**Syntax:** obj \<\< Set Tab Margin( all \| horizontal,vertical \| left,top,right,bottom )

**Description:** Sets the margin for the tabs. Inputted parameters can be applied to all sides, the horizontal and vertical sizes, or different values for each side.
...
### [Set Tab New](#set-tab-new)[](#set-tab-new "Click to copy url")

**Syntax:** obj \<\< Set Tab New( script\|Function( {this}, \<script\> ) )

**Description:** Sets the script or Function to run when the New tab is clicked. The script or function is responsible for creating the new tab.
...
### [Set Tab New Icon](#set-tab-new-icon)[](#set-tab-new-icon "Click to copy url")

**Syntax:** obj \<\< Set Tab New Icon( "string" )

**Description:** Sets the icon of the New tab.
...
### [Set Tab New Tip](#set-tab-new-tip)[](#set-tab-new-tip "Click to copy url")

**Syntax:** obj \<\< Set Tab New Tip( "string" )

**Description:** Sets the tooltip of the New tab.
...
### [Set Title Location](#set-title-location)[](#set-title-location "Click to copy url")

**Syntax:** obj \<\< Set Title Location( "Auto"\|"Top"\|"Bottom"\|"Left"\|"Right" )

**Description:** Set the location of the tab page titles. With a setting of "Auto", the location is chosen automatically depending on the size of the content. This option only applies if the style is set to Tabbed.
...
### [Show Tabs](#show-tabs)[](#show-tabs "Click to copy url")

**Syntax:** obj \<\< Show Tabs( state=0\|1 )

**Description:** Shows or hides the tabs.
...
[ Previous](StringColEditBox.html "StringColEditBox") [Next ](TabPageBox.html "TabPageBox")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/TabPageBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/TabPageBox.html)*

---

# [TabPageBox](#tabpagebox)[](#tabpagebox "Click to copy url")
...
**Description:** Closes the tab, if it is closeable.
...
### [Closeable](#closeable)[](#closeable "Click to copy url")

**Syntax:** obj \<\< Closeable( state=0\|1 )

**Description:** Sets the closeable status of the tab.
...
### [Focus Color](#focus-color)[](#focus-color "Click to copy url")

**Syntax:** obj \<\< Focus Color( color ); color = obj \<\< Get Focus Color

**Description:** If the focus color is set, it is used for the focus bar on the tab title when the tab or a box within it has focus.
...
New Window( "Example",
    V List Box(
        Tab Box(
            ...
            Tab Page Box(
                Title( "beta" ),
                Text Edit Box( "more text" ),
                <<Focus Color( "Fuchsia" )
            ),
            Tab Page Box( Title( "gamma" ), Text Edit Box( "still more text" ) ),
            <<Margin( 20 ),
            <<Padding( 20 )
        ),
        Text Edit Box( "outside text", <<Margin( 20 ) )
    )
);
Show( tp << Get Focus Color );
tp << Focus Color( "Blue" );
```
...
### [Get Close](#get-close)[](#get-close "Click to copy url")

**Syntax:** obj \<\< Get Close

**Description:** Returns the script that is run when the tab is closed from a script or through the close icon. The script should return 1 to allow the close, or 0 to cancel the close.
...
tp << Set Close( Function( {this}, 1 ) );
tp << Get Close;
```

### [Get Close Tip](#get-close-tip)[](#get-close-tip "Click to copy url")

**Syntax:** "string" = obj \<\< Get Close Tip
...
tp << Closeable( 1 );
tp << Set Close( Function( {this}, 1 ) );
tp << Set Close Tip( "Close Tab" );
Print( tp << Get Close Tip() );
```

### [Get Closeable](#get-closeable)[](#get-closeable "Click to copy url")

**Syntax:** "bool" = obj \<\< Get Closeable

**Description:** Returns the closeable status of the tab.
...
tp << Closeable( 1 );
Print( tp << Get Closeable( 2 ) );
```

### [Get Focus Color](#get-focus-color)[](#get-focus-color "Click to copy url")
...
**Syntax:** "string" = obj \<\< Get Icon

**Description:** Returns the icon of the tab.
...
### [Get Moveable](#get-moveable)[](#get-moveable "Click to copy url")

**Syntax:** obj \<\< Get Moveable

**Description:** Returns the moveable setting of the box.
...
**Description:** Returns a reference to the scriptable object associated with the Tab Page Box.
...
tp3 << Set Scriptable Object( tb );
Wait( 2 );
tp3 << Get Scriptable Object();
```
...
**Description:** Returns the tooltip of the tab
...
**Description:** Returns the title of the Tab Page Box.
...
### [Icon](#icon)[](#icon "Click to copy url")

**Syntax:** obj \<\< Icon( "string" )

**Description:** Sets the icon of the tab.
...
**Description:** Lock the tab page title to prevent interactive changes.
...
### [Moveable](#moveable)[](#moveable "Click to copy url")

**Syntax:** obj \<\< Moveable( state=0\|1 )

**Description:** Moveable boxes can be rearranged within a dockable box using drag-and-drop.
...
### [Set Close](#set-close)[](#set-close "Click to copy url")

**Syntax:** obj \<\< Set Close( script\|Function( {this}, \<script\> ) )

**Description:** Set the script or Function to run when the tab is closed from a script or through the close icon. The script or Function should return 1 to allow the close, or 0 to cancel the close.
...
### [Set Close Tip](#set-close-tip)[](#set-close-tip "Click to copy url")

**Syntax:** obj \<\< Set Close Tip( "string" )
...
**Description:** Sets the scriptable object associated with the Tab Page Box. Tab Page Box will show a red triangle menu of messages that can be sent to the scriptable object. If no argument is provided, the scriptable object will be cleared.
...
**Description:** Set a function that runs when the tab page title is changed.
...
### [Tip](#tip)[](#tip "Click to copy url")

**Syntax:** obj \<\< Tip( "string" )

**Description:** Sets the tooltip of the tab.
...
**Syntax:** obj \<\< Title( "string", \<Run Script(0 \| 1)\> )

**Description:** Sets the title of the Tab Page Box.
...
[ Previous](TabListBox.html "TabListBox") [Next ](TableBox.html "TableBox")

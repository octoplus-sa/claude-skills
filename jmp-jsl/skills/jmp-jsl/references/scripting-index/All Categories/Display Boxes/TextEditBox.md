...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/TextEditBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/TextEditBox.html)*

---

# [TextEditBox](#texteditbox)[](#texteditbox "Click to copy url")
...
**Description:** Returns a display box that contains editable text.
...
### [Bullet point](#bullet-point)[](#bullet-point "Click to copy url")

**Syntax:** obj \<\< Bullet point( state=0\|1 )

**Description:** Draws a bullet character, which precedes the text.
...
### [Fixed Size](#fixed-size)[](#fixed-size "Click to copy url")

**Syntax:** obj \<\< Fixed Size( state=0\|1, \<width\>, \<height\> )

**Description:** If enabled, the TextBox does not expand if the width of the text is greater than the width of the TextBox.
...
### [Get Bullet](#get-bullet)[](#get-bullet "Click to copy url")

**Syntax:** bullet = obj \<\< Get Bullet

**Description:** Returns a value indicating whether a bullet character is drawn before the text.
...
**Description:** Get the function that is executed after the text is edited.
...
### [Get Hidden State](#get-hidden-state)[](#get-hidden-state "Click to copy url")
...
### [Get Hint](#get-hint)[](#get-hint "Click to copy url")

**Syntax:** "string" = obj \<\< Get Hint

**Description:** Text that is displayed as a hint when the Text Box is empty.
...
### [Get Justify](#get-justify)[](#get-justify "Click to copy url")

**Syntax:** justify = obj \<\< Get Justify

**Description:** Left, center, or right justifies the text.
...
**Description:** Returns the rotation of the text.
...
**Description:** Returns the string content of the box.
...
### [Get Text Changed](#get-text-changed)[](#get-text-changed "Click to copy url")

**Syntax:** function = obj \<\< Get Text Changed

**Description:** Returns the function that is executed each time a change is made to the text.
...
**Description:** Returns the tooltip of the Text Box.
...
**Description:** Returns the width of the TextBox.
...
### [Get Wrap](#get-wrap)[](#get-wrap "Click to copy url")

**Syntax:** obj \<\< Get Wrap

**Description:** Returns the current wrap point in pixels
...
### [Hide](#hide)[](#hide "Click to copy url")

**Syntax:** obj \<\< Hide( state=0\|1 )

**Description:** Shows or hides the text.
...
### [Justify Text](#justify-text)[](#justify-text "Click to copy url")

**Syntax:** obj \<\< Justify Text( "Left"\|"Center"\|"Right" )
...
### [Markup](#markup)[](#markup "Click to copy url")

**Syntax:** obj \<\< Markup( state=0\|1 )

**Description:** Indicates that the text might contain HTML markup and should be interpreted. The HTML tags supported are bold (), italic (), underlined(), font face(), font color(), font size(, and background color(). For font color and background color, you can specify the color by name (blue), by hexadecimal triplet, specified in HTML syntax (#0000ff), or hexadecimal format (0x0000ff). If a name specifies a color, the name uses the JMP definition of the color.
...
### [Password Style](#password-style)[](#password-style "Click to copy url")

**Syntax:** obj \<\< Password Style( state=0\|1 )

**Description:** If enabled, the TextEditBox shows \*\*\*\*\* instead of passwords.
...
### [Preprocess Markup](#preprocess-markup)[](#preprocess-markup "Click to copy url")

**Syntax:** obj \<\< Preprocess Markup( state=0\|1 )

**Description:** Indicates that the text should be preprocessed to replace JMP markup tags with properly formatted HTML tags.
...
**Description:** Restores the text content to its initial value.
...
### [Rotate Text](#rotate-text)[](#rotate-text "Click to copy url")

**Syntax:** obj \<\< Rotate Text( left\|right\|horizontal )

**Description:** Rotates the text 90 degrees left or right, or returns it to the horizontal.
...
**Syntax:** obj \<\< Set Script( script ) obj \<\< Script( script )

**Description:** After the text is edited, the specified script will execute.
...
**Description:** Sets the given function for the control. The function's script runs when the change to the Text Edit Box is committed.
...
### [Set Hint](#set-hint)[](#set-hint "Click to copy url")
...
**Description:** Changes the string content of the box. For Text Edit Box, an optional Run Script(bool) argument sets whether the Text Edit Box's script is run when Set Text runs. The default value is 0 (does not run the script).
...
### [Set Text Changed](#set-text-changed)[](#set-text-changed "Click to copy url")

**Syntax:** obj \<\< Set Text Changed( Function( {this, value}, \<script\> ) )

**Description:** Sets the function that is executed each time a change is made to the text. This callback is called during editing before the change is committed. In the case of a canceled Edit operation, an additional callback will be generated to provide the original value.
...
**Description:** Sets the tooltip of the Text Box.
...
**Description:** Sets the width of the TextBox.
...
### [Set Wrap](#set-wrap)[](#set-wrap "Click to copy url")

**Syntax:** obj \<\< Set Wrap( n )

**Description:** Set the wrap point, in pixels (n).
...
### [SetNLines](#setnlines)[](#setnlines "Click to copy url")

**Syntax:** obj \<\< SetNLines( number )

**Description:** Sets the number of lines the text can appear on.
...
### [White Box Style](#white-box-style)[](#white-box-style "Click to copy url")

**Syntax:** obj \<\< White Box Style( 0=ordinary text, 1=bordered white box entry field )

**Description:** Whether to appear as an entry field with the text inside a bordered white box, or just plain text that you can click to edit
...
[ Previous](TextBox.html "TextBox") [Next ](TextSeg.html "TextSeg")

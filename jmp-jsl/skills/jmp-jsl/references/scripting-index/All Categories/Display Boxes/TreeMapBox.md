...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/TreeMapBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/TreeMapBox.html)*

---

# [TreeMapBox](#treemapbox)[](#treemapbox "Click to copy url")
...
Treemap(
    ...
    Sizes( :POP ),
    SendToReport( Dispatch( {}, "", TreeMapBox, {Group Label Background( 0.25 )} ) )
);
```
...
Treemap(
    Categories( :city, :State ),
    Sizes( :POP ),
    SendToReport( Dispatch( {}, "", TreeMapBox, {Ignore Group Hierarchy( 1 )} ) )
);
```
...
Treemap(
    Categories( :city, :State ),
    Sizes( :POP ),
    SendToReport( Dispatch( {}, "", TreeMapBox, {Show Group Labels( 0 )} ) )
);
```
...
Treemap(
    Categories( :city, :State ),
    Sizes( :POP ),
    SendToReport( Dispatch( {}, "", TreeMapBox, {Show  Labels( 0 )} ) )
);
```
...
Treemap(
    Categories( :city, :State ),
    Sizes( :POP ),
    SendToReport( Dispatch( {}, "", TreeMapBox, {Suppress Box Frames( 1 )} ) )
);
```
...
[ Previous](TreeBox.html "TreeBox") [Next ](TreeMapSeg.html "TreeMapSeg")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/WebBrowserBox.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/WebBrowserBox.html)*

---

# [WebBrowserBox](#webbrowserbox)[](#webbrowserbox "Click to copy url")
...
### [Execute Script](#execute-script)[](#execute-script "Click to copy url")

**Syntax:** "Promise" = obj \<\< Execute Script

**Description:** Asynchronously executes the given Javascript in context of the current page. Returns a promise for the script result (as a string)
...
wb << Set Max Size( 10000, 10000 );
Wait( 2 );
wb << Execute Script( "document.title = \!"New Title\!"" );
```

**Example 2**

``` jsl
// Example illustrating navigating Web Browser Box to a URL and retrieve the page HTML source.
New Window( "Example", wb = Web Browser Box() );
wb << Navigate( "http://www.jmp.com" );
wb << Set Stretch( "Window", "Window" );
wb << Set Max Size( 10000, 10000 );
Wait( 2 );
Process Content = Function( {promise, response},
    content = response;

// Possibly remove outer double-quotes
    If(
        Length( content ) >= 2 & Substr( content, 1, 1 ) == "\!"" & Substr( content, -1, 1 )
         == "\!"",
...
// Print HTML source to Log.
    Print( content );
);

p = wb << Execute Script( "document.documentElement.outerHTML" );
p << On Result( Process Content );
```

### [Get URL](#get-url)[](#get-url "Click to copy url")

**Syntax:** "URL" = obj \<\< Get URL

**Description:** Returns the URL that the browser has navigated to.
...
### [Navigate](#navigate)[](#navigate "Click to copy url")

**Syntax:** obj \<\< Navigate( "URL" )

**Description:** Browses to the specified URL.
...
[ Previous](UnlineUpBox.html "UnlineUpBox") [Next ](WordCloudBox.html "WordCloudBox")

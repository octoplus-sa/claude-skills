...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/gline.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/gline.html)*

---

# [gline](#gline)[](#gline "Click to copy url")
...
rbiv = biv << report;
la = rbiv << Add Line Annotation( Line( 100, 50, 240, 100 ) );
la << Color( "Red" );
```

### [Dashed](#dashed)[](#dashed "Click to copy url")

**Syntax:** obj \<\< Dashed( state=0\|1 )

**Description:** Enables or disables a dashed line.
...
**Syntax:** obj \<\< Line( x1,y1,x2,y2 )

**Description:** Draws a line on top of the display box.
...
### [Point from](#point-from)[](#point-from "Click to copy url")

**Syntax:** obj \<\< Point from( state=0\|1 )

**Description:** Draws (1) or removes (0) an arrow at the beginning of the line.
...
### [Point to](#point-to)[](#point-to "Click to copy url")

**Syntax:** obj \<\< Point to( state=0\|1 )

**Description:** Draws (1) or removes (0) an arrow at the end of the line.
...
### [Thick](#thick)[](#thick "Click to copy url")

**Syntax:** obj \<\< Thick( state=0\|1 )

**Description:** Draws the line thick (1) or thin (0).
...
[ Previous](gdisplaybox.html "gdisplaybox") [Next ](gpin.html "gpin")

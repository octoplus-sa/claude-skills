...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/gpin.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/gpin.html)*

---

# [gpin](#gpin)[](#gpin "Click to copy url")

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Add Text](#add-text)[](#add-text "Click to copy url")

**Syntax:** obj \<\< Add Text( "string" )

**Description:** Adds a custom block of text to the pinned hover label.
...
gpin << Add Text( "And now for something completely different!" );
```
...
### [Click Link](#click-link)[](#click-link "Click to copy url")

**Syntax:** obj \<\< Click Link( "\<index, integer\>" )

**Description:** Simulates a click action on the link associated with the given text or index. If none is provided, assumes the last link, which is usually the graphlet, if present.
...
frame << Set Gridlet(
    Annex(
        {{Matcher( "My Link" ), value( "Click Me!" ), click( Web( "https://jmp.com" ) )}}
    )
);
gpin = frame << Add Pin Annotation(
    Seg( BarSeg( 1 ) ),
...
links = gpin << Get Links;
Show( links );
gpin << Click Link( 1 );
gpin << Click Link( links[1] );
gpin << Click Link();
```
...
**Description:** Closes the hover label.
...
### [Copy](#copy)[](#copy "Click to copy url")

**Syntax:** "string" = obj \<\< Copy

**Description:** Copies the hover label contents to the clipboard.

If the operation is assigned to a variable, the hover label text content is stored in it.
...
**Description:** Removes the annotation from on top of the display box.
...
### [Deleteable](#deleteable)[](#deleteable "Click to copy url")

**Syntax:** obj \<\< Deleteable

**Description:** Allows "delete" to be removed from the context menu
...
**Description:** Launches a visual editor for the contents of the hover label.
...
### [Filled](#filled)[](#filled "Click to copy url")

**Syntax:** obj \<\< Filled( state=0\|1 )

### [Font](#font)[](#font "Click to copy url")

**Syntax:** obj \<\< Font

**Description:** Sets the pinned hover label font.
...
### [Get Links](#get-links)[](#get-links "Click to copy url")

**Syntax:** obj \<\< Get Links

**Description:** "Returns a list of the text associated with the clickable entries in the hover label.

Pictures and graphlets are associated with an empty string
...
### [Get Local Context](#get-local-context)[](#get-local-context "Click to copy url")

**Syntax:** Associative Array = obj \<\< Get Local Context

**Description:** Returns an associative array with the names and values of the local variables provided as part of the hover label execution context.

See graphlet preset definitions for usage examples.
...
### [Launch graphlet](#launch-graphlet)[](#launch-graphlet "Click to copy url")

**Syntax:** obj \<\< Launch graphlet

**Description:** Launches the graphlet visualization or platform in a new window.

The launcher/previous content can be recovered with an Undo command.

The same functionality is provided by Clicking on the graphlet thumbnail.
...
### [Launch in last](#launch-in-last)[](#launch-in-last "Click to copy url")

**Syntax:** obj \<\< Launch in last

**Description:** Launches the graphlet visualization or platform in a new window or in the last launched window, replacing its contents.

The launcher/previous content can be recovered with an Undo command.

The same functionality is provided by Alt-Clicking on the graphlet thumbnail.
...
gpin = frame << Add Pin Annotation(
    ...
    UniqueID( -1293538908 ),
    FoundPt( {465, 179} ),
    Origin( {4.14739884393064, 108.411354449472} ),
    Tag Line( 1 )
);
Wait( 3 );
gpin << Launch in last;
...
### [Launch in place](#launch-in-place)[](#launch-in-place "Click to copy url")

**Syntax:** obj \<\< Launch in place

**Description:** Launches the graphlet visualization or platform in the current window, replacing its contents.

The launcher/previous content can be recovered with an Undo command.

The same functionality is provided by Control-Clicking on the graphlet thumbnail.
...
Wait( 3 );
gpin << Launch in Place;
```

### [Pin](#pin)[](#pin "Click to copy url")

**Syntax:** obj \<\< Pin

### [Reanchor](#reanchor)[](#reanchor "Click to copy url")

**Syntax:** obj \<\< Reanchor

### [Replace Text](#replace-text)[](#replace-text "Click to copy url")

**Syntax:** obj \<\< Replace Text( "string" )

**Description:** Replaces the pinned hover label text content with the given text.
...
### [Revert Text](#revert-text)[](#revert-text "Click to copy url")

**Syntax:** obj \<\< Revert Text

**Description:** Reverts the pinned hover label text content to its original text.
...
**Description:** Launches a data table with a local data filter that shows only the subset of the data associated with the visual element under the hover label.
...
### [Tag Line](#tag-line)[](#tag-line "Click to copy url")

**Syntax:** obj \<\< Tag Line( state=0\|1 )

### [Text Color](#text-color)[](#text-color "Click to copy url")

**Syntax:** obj \<\< Text Color( color )

### [Unanchor](#unanchor)[](#unanchor "Click to copy url")

**Syntax:** obj \<\< Unanchor

### [Use Gradient](#use-gradient)[](#use-gradient "Click to copy url")

**Syntax:** obj \<\< Use Gradient( state=0\|1 )
...
[ Previous](gline.html "gline") [Next ](gpolygon.html "gpolygon")

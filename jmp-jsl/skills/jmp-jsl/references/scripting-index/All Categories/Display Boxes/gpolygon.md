...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/gpolygon.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/gpolygon.html)*

---

# [gpolygon](#gpolygon)[](#gpolygon "Click to copy url")

## [Item Messages](#item-messages)[](#item-messages "Click to copy url")

### [Closed](#closed)[](#closed "Click to copy url")

**Syntax:** obj \<\< Closed( state=0\|1 )

**Description:** If enabled, the polygon automatically has an interior even if the starting and ending points do not match.

``` jsl
Open( "$SAMPLE_DATA/Big Class.jmp" );
biv = bivariate( y( :weight ), x( :height ) );
rbiv = biv << report;
pa = rbiv << Add Polygon Annotation( Points( {210, 80}, {230, 70}, {280, 115}, {240, 120} ) );
pa << Closed( 1 );
```
...
**Description:** Sets the color of the polygon.
...
**Description:** Enables or disables a filled polygon.
...
**Description:** Sets the points the polygon should extend to.

``` jsl
Open( "$SAMPLE_DATA/Big Class.jmp" );
biv = bivariate( y( :weight ), x( :height ) );
rbiv = biv << report;
pa = rbiv << Add Polygon Annotation();
pa << Points( {255, 125}, {210, 80}, {250, 70} );
pa << closed( 0 );
pa << Color( "Red" );
```

### [Raised](#raised)[](#raised "Click to copy url")

**Syntax:** obj \<\< Raised( state=0\|1 )

**Description:** Enables or disables a raised polygon.
...
### [Smooth](#smooth)[](#smooth "Click to copy url")

**Syntax:** obj \<\< Smooth( state=0\|1 )

**Description:** Enables or disables a smooth polygon.
...
[ Previous](gpin.html "gpin") [Next ](gshape.html "gshape")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/gshape.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/gshape.html)*

---

# [gshape](#gshape)[](#gshape "Click to copy url")
...
rbiv = biv << report;
xaxis = rbiv[axisbox( 2 )];
{xsize, ysize} = xaxis << getsize;
ovalshape = xaxis << Add Simple Shape Annotation( Oval( 0, 0, xsize / 2, ysize ) );
ovalshape << Color( "Green" );
```
...
**Description:** Enables or disables a filled shape.
...
**Syntax:** obj \<\< Oval( x1,y1,x2,y2 )

**Description:** Draws an oval on top of the display box.
...
**Description:** Enables or disables a raised shape.
...
### [Rectangle](#rectangle)[](#rectangle "Click to copy url")

**Syntax:** obj \<\< Rectangle( x1,y1,x2,y2 )

**Description:** Draws a rectangle on top of the display box.
...
[ Previous](gpolygon.html "gpolygon") [Next ](gtext.html "gtext")

...
*Source: [https://jsl.jmp.com/All%20Categories/Display%20Boxes/gtext.html](https://jsl.jmp.com/All%20Categories/Display%20Boxes/gtext.html)*

---

# [gtext](#gtext)[](#gtext "Click to copy url")
...
### [Editable](#editable)[](#editable "Click to copy url")

**Syntax:** obj \<\< Editable( state=0\|1 )

**Description:** If enabled (1), text can be clicked on with a mouse to be edited.
...
**Description:** Enables or disables filled text.
...
ta = rbiv << Add Text Annotation();
ta << Text( "We need to discuss this at the next meeting." );
ta << Text Box( {65, 50, 200, 77} );
ta << Filled;
```

### [Fixed Size](#fixed-size)[](#fixed-size "Click to copy url")

**Syntax:** obj \<\< Fixed Size( state=0\|1 )

**Description:** If enabled, honors the user-defined annotation size; otherwise, calculates it based on the text content.
...
**Syntax:** obj \<\< Font( face,\<size\>,\<style\> )
...
ta << Text( "We need to discuss this at the next meeting." );
ta << Background Color( "Blue" );
Print( ta << Get Background Color );
```

### [Get Font](#get-font)[](#get-font "Click to copy url")

**Syntax:** font = obj \<\< Get Font

**Description:** Returns the text font.
...
**Syntax:** color = obj \<\< Get Text Color
...
ta << Text( "We need to discuss this at the next meeting." );
ta << Text Color( "Blue" );
Print( ta << Get Text Color );
```

### [GetEditable](#geteditable)[](#geteditable "Click to copy url")

**Syntax:** 0\|1 = obj \<\< GetEditable

**Description:** Returns if the text is editable.
...
ta = rbiv << Add Text Annotation();
ta << Text( "We need to discuss this at the next meeting." );
Print( ta << Get Editable );
```

### [GetFilled](#getfilled)[](#getfilled "Click to copy url")

**Syntax:** 0\|1 = obj \<\< GetFilled

**Description:** Returns if the text is filled.
...
### [GetOctant](#getoctant)[](#getoctant "Click to copy url")

**Syntax:** N\|NE\|E\|SE\|S\|SW\|W\|NW = obj \<\< GetOctant

**Description:** Returns the location that the text is drawn in.
...
### [GetTagLine](#gettagline)[](#gettagline "Click to copy url")

**Syntax:** 0\|1 = obj \<\< GetTagLine

**Description:** Returns if the tag line is enabled (1) or disabled (0).
...
ta << Text( "We need to discuss this at the next meeting." );
ta << Tag Line;
Print( ta << Get Tag Line );
```

### [GetText](#gettext)[](#gettext "Click to copy url")

**Syntax:** "string" = obj \<\< GetText
...
### [Justification](#justification)[](#justification "Click to copy url")

**Syntax:** obj \<\< Justification( "string" )
...
rbiv = biv << report;
ta = rbiv << Add Text Annotation();
ta << Text( "We need to discuss this
at the next
meeting." );
ta << Justification( "center" );
```

### [Minimized](#minimized)[](#minimized "Click to copy url")

**Syntax:** obj \<\< Minimized( state=0\|1 )
...
### [Octant](#octant)[](#octant "Click to copy url")

**Syntax:** obj \<\< Octant( \<N\|NE\|E\|SE\|S\|SW\|W\|NW\> )

**Description:** Sets the location in the display box that the text should be drawn.
...
### [Tag Anchor](#tag-anchor)[](#tag-anchor "Click to copy url")

**Syntax:** obj \<\< Tag Anchor

### [Tag Line](#tag-line)[](#tag-line "Click to copy url")

**Syntax:** obj \<\< Tag Line( state=0\|1 )

**Description:** Adds a line from the upper left of the display box to the text
...
**Syntax:** obj \<\< Text( "string" )

**Description:** Sets the text to string.
...
**Syntax:** obj \<\< Text Box( x1,y1,x2,y2 )

**Description:** Places the text in a Text Box.
...
[ Previous](gshape.html "gshape") [Next ](../Functions/All%20Functions.html "All Functions")

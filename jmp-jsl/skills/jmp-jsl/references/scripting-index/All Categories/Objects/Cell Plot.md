...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Cell%20Plot.html](https://jsl.jmp.com/All%20Categories/Objects/Cell%20Plot.html)*
...
### [Cell Plot](#cell-plot_1)[](#cell-plot_1 "Click to copy url")
...
### [Arrange Plots](#arrange-plots)[](#arrange-plots "Click to copy url")

**Syntax:** obj \<\< Arrange Plots( number across )

**Description:** Arranges the plots horizontally. Only available when an X variable is present.
...
### [Center at zero](#center-at-zero)[](#center-at-zero "Click to copy url")

**Syntax:** Cell Plot( Y( columns ), Center at Zero( state=0\|1 ) )
...
**Description:** Displays or hides the legend appended to the end of the plot.
...
### [Scale Uniformly](#scale-uniformly)[](#scale-uniformly "Click to copy url")

**Syntax:** Cell Plot( Y( columns ), Scale Uniformly( state=0\|1 ) )
...
**Syntax:** obj = Cell Plot(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Categorical.html "Categorical") [Next ](Choice.html "Choice")

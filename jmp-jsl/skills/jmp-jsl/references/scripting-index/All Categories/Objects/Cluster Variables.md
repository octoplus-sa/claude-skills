...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Cluster%20Variables.html](https://jsl.jmp.com/All%20Categories/Objects/Cluster%20Variables.html)*
...
### [Cluster Variables](#cluster-variables_1)[](#cluster-variables_1 "Click to copy url")
...
**Syntax:** obj = Cluster Variables(...\<By( column(s) )\>...)
...
**Syntax:** obj = Cluster Variables(...\<Freq( column )\>...)
...
**Syntax:** obj = Cluster Variables(...\<Weight( column )\>...)
...
**Syntax:** obj = Cluster Variables(...Y( column(s) )...)

**Description:** Specifies the variables to be clustered.
...
**Syntax:** obj = Cluster Variables(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Class.html "Class") [Next ](Cluster.html "Cluster")

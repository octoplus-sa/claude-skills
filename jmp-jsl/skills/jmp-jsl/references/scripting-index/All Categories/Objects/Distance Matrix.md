...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Distance%20Matrix.html](https://jsl.jmp.com/All%20Categories/Objects/Distance%20Matrix.html)*
...
### [Distance Matrix](#distance-matrix_1)[](#distance-matrix_1 "Click to copy url")
...
**Syntax:** Method( "Row Standardize" \| "Wrench" )

**Description:** Specifies the distance method.
...
### [Number of Permutations](#number-of-permutations)[](#number-of-permutations "Click to copy url")

**Syntax:** Permutations ( number = 1000 )
...
### [Number of Principal Components](#number-of-principal-components)[](#number-of-principal-components "Click to copy url")
...
**Syntax:** obj = Distance Matrix(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Discriminant.html "Discriminant") [Next ](Distribution.html "Distribution")

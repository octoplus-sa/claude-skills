...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Fit%20Two%20Level%20Screening.html](https://jsl.jmp.com/All%20Categories/Objects/Fit%20Two%20Level%20Screening.html)*

---

# [Fit Two Level Screening](#fit-two-level-screening)[](#fit-two-level-screening "Click to copy url")

## [Associated Constructors](#associated-constructors)[](#associated-constructors "Click to copy url")

### [Fit Two Level Screening](#fit-two-level-screening_1)[](#fit-two-level-screening_1 "Click to copy url")

**Syntax:** Fit Two Level Screening( Y( column ), X( columns ) )
...
obj = dt << Fit Two Level Screening(
    Y( :Percent Reacted ),
...
**Syntax:** obj = Fit Two Level Screening(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Fit%20Model.html "Fit Model") [Next ](Fit%20Y%20by%20X%20Group.html "Fit Y by X Group")

...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Group%20Platform.html](https://jsl.jmp.com/All%20Categories/Objects/Group%20Platform.html)*

---

# [Group Platform](#group-platform)[](#group-platform "Click to copy url")

## [Associated Constructors](#associated-constructors)[](#associated-constructors "Click to copy url")

### [Group Options](#group-options)[](#group-options "Click to copy url")

**Syntax:** obj = Platform( \<Roles\>, \<Platform Options\>, Group Options(\<Return Group(0\|1)\>, \<options\>))

**Description:** A Group Platform arranges reports for platforms that are created when launching with a By role or multiple Y roles. A Group Platform cannot be created directly, but is created when a launch can result in multiple platforms being created. Options for the group behavior are specified with the Group Options argument at launch.

#### [Group Platform return](#group-platform-return)[](#group-platform-return "Click to copy url")
...
#### [Platform list return](#platform-list-return)[](#platform-list-return "Click to copy url")
...
### [Auto Broadcast](#auto-broadcast)[](#auto-broadcast "Click to copy url")

**Syntax:** obj \<\< Auto Broadcast( state=0\|1 )

**Description:** Automatically apply broadcast for interactive actions in reports.
...
### [Get Auto Broadcast](#get-auto-broadcast)[](#get-auto-broadcast "Click to copy url")

**Syntax:** obj \<\< Get Auto Broadcast

**Description:** Returns the setting for automatically applying broadcast for interactive actions in reports.
...
### [Get Hide Empty Platforms](#get-hide-empty-platforms)[](#get-hide-empty-platforms "Click to copy url")

**Syntax:** obj \<\< Get Hide Empty Platforms

**Description:** Returns the setting for hiding empty platforms.
...
**Description:** Returns the current layout of the platform group.
...
### [Get N Across](#get-n-across)[](#get-n-across "Click to copy url")

**Syntax:** obj \<\< Get N Across

**Description:** Returns the number of platforms across for Arrange in Rows layout.
...
### [Get Platforms](#get-platforms)[](#get-platforms "Click to copy url")

**Syntax:** list = Get Platforms(\<Visible Only(0\|1)\>)

**Description:** Returns a list of the platforms in the group. If the VisibleOnly option is specified, hidden platforms will not be included and the list will be in the order of display.

#### [All platforms](#all-platforms)[](#all-platforms "Click to copy url")
...
#### [Visible only](#visible-only)[](#visible-only "Click to copy url")
...
### [Hide Empty Platforms](#hide-empty-platforms)[](#hide-empty-platforms "Click to copy url")

**Syntax:** obj \<\< Hide Empty Platforms( state=0\|1 )

**Description:** Hide the empty platforms that are unable to compute.
...
**Syntax:** obj \<\< Layout( "Vertical List"\|"Horizontal List"\|"Arrange in Rows"\|"Arrange in Tabs" )

**Description:** Change the layout of the platforms in the group.
...
### [N Across](#n-across)[](#n-across "Click to copy url")

**Syntax:** obj \<\< N Across( number )

**Description:** Set the number of platforms across for Arrange in Rows layout.
...
**Description:** Sets the order for the platforms in the group. The order can be based on a platform-computed value, a column statistic when used with by-groups, or a response statistic when the group was launched with multiple Y's. By default, the order is descending with a stat of "Mean".

#### [Column statistic](#column-statistic)[](#column-statistic "Click to copy url")
...
#### [Response statistic](#response-statistic)[](#response-statistic "Click to copy url")
...
**Syntax:** obj = Group Options(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](GridBox.html "GridBox") [Next ](HTTP.html "HTTP")

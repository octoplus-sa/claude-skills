...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Item%20Analysis.html](https://jsl.jmp.com/All%20Categories/Objects/Item%20Analysis.html)*
...
### [Item Analysis](#item-analysis_1)[](#item-analysis_1 "Click to copy url")
...
obj = Item Analysis( Y( :Q1, :Q2, :Q3, :Q4, :Q5, :Q6, :Q7, :Q8, :Q9 ), Freq( :_freqcol ) );
```

### [Test Items](#test-items)[](#test-items "Click to copy url")

**Syntax:** obj \<\< Test Items( column(s) )
...
**Syntax:** obj = Item Analysis(...Model( "Logistic 2PL"\|"Logistic 3PL"\|"Logistic 1PL" )...)

**Description:** Identifies the model used for the Item Analysis.
...
**Description:** Changes the layout of the Item Characteristic Curves which are closed by default.
...
### [Save Ability Formula](#save-ability-formula)[](#save-ability-formula "Click to copy url")

**Syntax:** obj \<\< Save Ability Formula

**Description:** Saves the ability formula to a new column in the data table.
...
**Syntax:** obj = Item Analysis(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Image.html "Image") [Next ](JMP%20App%20Module%20Instance.html "JMP App Module Instance")

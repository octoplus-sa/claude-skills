...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Marker%20Simulation.html](https://jsl.jmp.com/All%20Categories/Objects/Marker%20Simulation.html)*
...
### [Marker Simulation](#marker-simulation_1)[](#marker-simulation_1 "Click to copy url")
...
### [Cross](#cross)[](#cross "Click to copy url")

**Syntax:** obj \<\< Cross( column(s) )

**Description:** Specifies a column that groups the samples into blocks. Crosses are then made between samples of different groups.
...
**Description:** Specifies columns that contain prediction formulas for responses or traits.
...
### [Estimate Diversity](#estimate-diversity)[](#estimate-diversity "Click to copy url")

**Syntax:** obj = Marker Simulation(...Estimate Diversity( state=0\|1 )...)

**Description:** Estimates genetic diversity for the simulated individuals.
...
### [Imputation Value](#imputation-value)[](#imputation-value "Click to copy url")
...
### [Missing Marker Imputation Method](#missing-marker-imputation-method)[](#missing-marker-imputation-method "Click to copy url")

**Syntax:** obj = Marker Simulation(...Missing Marker Imputation Method( "HWE Off"\|"HWE On"\|"Random"\|"Specified"="HWE Off" )...)
...
### [Number of Generations](#number-of-generations)[](#number-of-generations "Click to copy url")

**Syntax:** obj = Marker Simulation(...Number of Generations( number=1 )...)

**Description:** Specifies the number of generations to go through in the crosses and selection process. "1" by default.
...
### [Number of Individuals per Cross](#number-of-individuals-per-cross)[](#number-of-individuals-per-cross "Click to copy url")

**Syntax:** obj = Marker Simulation(...Number of Individuals per Cross( number=5 )...)

**Description:** Specifies the number of individuals to be simulated per cross. "5" by default.
...
### [Number of Selected Crosses](#number-of-selected-crosses)[](#number-of-selected-crosses "Click to copy url")

**Syntax:** obj = Marker Simulation(...Number of Selected Crosses( number=0 )...)

**Description:** Specifies the maximum number of families to be selected per generation. "0" by default.
...
### [Number of Selected Individuals](#number-of-selected-individuals)[](#number-of-selected-individuals "Click to copy url")

**Syntax:** obj = Marker Simulation(...Number of Selected Individuals( number=0 )...)

**Description:** Specifies the maximum number of individuals to be selected per family. "0" by default.
...
**Description:** Specifies an even number that indicates the ploidy level. "2" by default.
...
### [Save Simulated Table](#save-simulated-table)[](#save-simulated-table "Click to copy url")

**Syntax:** obj \<\< Save Simulated Table

**Description:** Saves the simulated genotypes to a new data table.
...
### [Select Best Individuals](#select-best-individuals)[](#select-best-individuals "Click to copy url")

**Syntax:** obj = Marker Simulation(...Select Best Individuals( state=0\|1 )...)

**Description:** Selects best individuals that meet all criteria specified on Spec Limits's Column Properties of Predictor Formulas.
...
### [Show Diversity Plot](#show-diversity-plot)[](#show-diversity-plot "Click to copy url")

**Syntax:** obj \<\< Show Diversity Plot( state=1 )

**Description:** Shows or hides the plot of genetic diversity. On by default.
...
### [Show Evaluation Plot](#show-evaluation-plot)[](#show-evaluation-plot "Click to copy url")

**Syntax:** obj \<\< Show Evaluation Plot( state=1 )

**Description:** Shows or hides the plot of genetic statistics. On by default.
...
### [Threshold to Make Line Plots](#threshold-to-make-line-plots)[](#threshold-to-make-line-plots "Click to copy url")

**Syntax:** obj = Marker Simulation(...Threshold to Make Line Plots( number=500 )...)

**Description:** Specifies a maximum number of crosses for which to draw line plots in the reports. Line plots are drawn when the total number of crosses is less than this threshold. "500" by default.
...
### [Use Only Markers Found in Predictor Formula](#use-only-markers-found-in-predictor-formula)[](#use-only-markers-found-in-predictor-formula "Click to copy url")

**Syntax:** obj = Marker Simulation(...Use Only Markers Found in Predictor Formula( state=0\|1 )...)

**Description:** Simulates only those markers found in the predictor formula.
...
[ Previous](Marker%20Relatedness.html "Marker Relatedness") [Next ](Marker%20Statistics.html "Marker Statistics")

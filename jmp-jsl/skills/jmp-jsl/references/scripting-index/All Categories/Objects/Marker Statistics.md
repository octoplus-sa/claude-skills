...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Marker%20Statistics.html](https://jsl.jmp.com/All%20Categories/Objects/Marker%20Statistics.html)*
...
### [Marker Statistics](#marker-statistics_1)[](#marker-statistics_1 "Click to copy url")
...
**Description:** Analyzes the rows assigned to each level of the specified column separately. All results are presented in a single table and report.
...
### [With Marker](#with-marker)[](#with-marker "Click to copy url")

**Syntax:** obj \<\< With Marker( column(s) )

**Description:** Specifies columns that contain genetic markers for pairwise linkage disequilibrium estimation with columns of genetic markers specified in Markers.
...
### [Counts Table](#counts-table)[](#counts-table "Click to copy url")

**Syntax:** obj \<\< Counts Table( state=1 )

**Description:** Shows or hides the table of counts by genotype levels. On by default.
...
### [LD Decay Plot](#ld-decay-plot)[](#ld-decay-plot "Click to copy url")

**Syntax:** obj \<\< LD Decay Plot( state=1 )

**Description:** Shows or hides the LD Decay Plot. On by default.
...
### [Levels Table](#levels-table)[](#levels-table "Click to copy url")

**Syntax:** obj \<\< Levels Table( state=1 )

**Description:** Shows or hides the table of genotype levels. On by default.
...
### [Marker Format](#marker-format)[](#marker-format "Click to copy url")

**Syntax:** obj = Marker Statistics(...Marker Format( "Numeric"\|"Single-Character"\|"Character"\|"Single-Code Nucleotide"\|"Nucleotide"="Numeric" )...)

**Description:** Provides options for choosing the format of genotypes: Single-Character (A, B, H), Single-Code Nucleotide (IUPAC: A,C,G,T,R,Y,S,W,K,M,+,0,-,N), Nucleotide (AA, CC, GG, TT, AC, AT, and son on), Numeric (0, 1, 2, ..., p) and Character (ApBp or Ap/Bp). Both Numeric and Character formats handle genotype with p-ploidy. "Numeric" by default.

### [PValue Plot](#pvalue-plot)[](#pvalue-plot "Click to copy url")

**Syntax:** obj \<\< PValue Plot( state=1 )

**Description:** Shows or hides the PValues Plot. On by default.
...
**Syntax:** obj = Marker Statistics(...PValues Table on Launch( state=0 )...)

**Description:** Specifies whether to create a PValues data table when the platform launches. "0" by default.
...
**Syntax:** obj = Marker Statistics(...Ploidy( number=2 )...)
...
### [Recode Marker](#recode-marker)[](#recode-marker "Click to copy url")

**Syntax:** obj \<\< Recode Marker

**Description:** Recodes all selected marker columns in the original data table by switching minor and major alleles.
...
### [Result Table](#result-table)[](#result-table "Click to copy url")

**Syntax:** obj \<\< Result Table( state=1 )

**Description:** Show the table of results On by default.
...
### [Save Counts Table](#save-counts-table)[](#save-counts-table "Click to copy url")

**Syntax:** obj \<\< Save Counts Table

**Description:** Saves the counts to a data table
...
### [Save Levels Table](#save-levels-table)[](#save-levels-table "Click to copy url")

**Syntax:** obj \<\< Save Levels Table

**Description:** Saves the levels to a data table
...
### [Save Proportion of Missing Markers](#save-proportion-of-missing-markers)[](#save-proportion-of-missing-markers "Click to copy url")

**Syntax:** obj \<\< Save Proportion of Missing Markers

**Description:** Adds a column to the original data table that contains the proportion of missing genotypes
...
### [Save Result Table](#save-result-table)[](#save-result-table "Click to copy url")

**Syntax:** obj \<\< Save Result Table

**Description:** Saves the results to a data table.
...
### [Select and Recode Marker](#select-and-recode-marker)[](#select-and-recode-marker "Click to copy url")

**Syntax:** obj \<\< Select and Recode Marker

**Description:** Selects and Recodes marker columns in the original data table by switching minor and major alleles.
...
**Syntax:** obj = Marker Statistics(...Unthreaded( state=0\|1 )...)
...
### [Use Annotation Table](#use-annotation-table)[](#use-annotation-table "Click to copy url")

**Syntax:** obj = Marker Statistics(...Use Annotation Table( state=0\|1 )...)

**Description:** Uses the annotation table that contains marker annotation group and position.
...
**Syntax:** obj = Marker Statistics(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Marker%20Simulation.html "Marker Simulation") [Next ](Matched%20Pairs.html "Matched Pairs")

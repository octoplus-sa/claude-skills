...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Model%20Driven%20Multivariate%20Control%20Chart.html](https://jsl.jmp.com/All%20Categories/Objects/Model%20Driven%20Multivariate%20Control%20Chart.html)*
...
### [Model Driven Multivariate Control Chart](#model-driven-multivariate-control-chart_1)[](#model-driven-multivariate-control-chart_1 "Click to copy url")
...
### [Change Point Detection](#change-point-detection)[](#change-point-detection "Click to copy url")

**Syntax:** obj \<\< Change Point Detection( state=0\|1 )

**Description:** Displays or hides a phase-detection plot of test statistics by row number and a scatterplot matrix.
...
### [Diagnose the Process](#diagnose-the-process)[](#diagnose-the-process "Click to copy url")

**Syntax:** obj \<\< Diagnose the Process( state=0\|1 )
...
### [Historical Data End at Row](#historical-data-end-at-row)[](#historical-data-end-at-row "Click to copy url")

**Syntax:** obj = Model Driven Multivariate Control Chart(...Historical Data End at Row( number )...)

**Description:** The specified row number splits the observations into historical and current data.
...
### [Normalized DModX Plot](#normalized-dmodx-plot)[](#normalized-dmodx-plot "Click to copy url")

**Syntax:** obj \<\< Normalized DModX Plot( state=0\|1 )

**Description:** Shows or hides a plot of the normalized DModX values. DModX measures the distance of each observation to the PCA or PLS model.
...
**Syntax:** obj \<\< Score Plot( state=0\|1 )

**Description:** Shows or hides a score plot of principal components or partial least squares factors.
...
**Description:** Specifies the alpha level that is used to compute the decision limits.
...
### [Set Component](#set-component)[](#set-component "Click to copy url")

**Syntax:** obj \<\< Set Component( number )

**Description:** Enables you to set the number of components for the T², DModX, and SPE plots.
...
**Description:** Shows or hides the alarm rate report.
...
**Description:** Shows or hides excluded rows on plots. When this option is selected, excluded rows are included in the count of out of control points, but excluded from numerical calculations. On by default.
...
### [Show History Summary Statistics](#show-history-summary-statistics)[](#show-history-summary-statistics "Click to copy url")

**Syntax:** obj \<\< Show History Summary Statistics( state=0\|1 )

**Description:** Shows or hides summary statistics that contain eigenvalues, principal component loadings, and process variable means and standard deviations. The means and standard deviations are calculated from historical data and are used to compute principal component scores, T square, squared prediction error (SPE), and DModX statistics for the current data.
...
### [Show Monitoring Plots](#show-monitoring-plots)[](#show-monitoring-plots "Click to copy url")

**Syntax:** obj \<\< Show Monitoring Plots( state=0\|1 )

**Description:** Shows or hides selected process monitoring plots.
...
### [Squared Prediction Error Plot](#squared-prediction-error-plot)[](#squared-prediction-error-plot "Click to copy url")

**Syntax:** obj \<\< Squared Prediction Error Plot( state=0\|1 )

**Description:** Shows or hides a plot of the squared prediction error (SPE). SPE measures the sum of squared residuals from the PCA or PLS model.
...
### [T² Plot](#t2-plot)[](#t2-plot "Click to copy url")

**Syntax:** obj \<\< T² Plot( state=0\|1 )

**Description:** Shows or hides a plot of the T² statistic. T² measures how far away an observation is from the center of a PCA or PLS model. On by default.
...
**Syntax:** obj = Model Driven Multivariate Control Chart(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Model%20Comparison.html "Model Comparison") [Next ](Model%20Screening.html "Model Screening")

...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Multidimensional%20Scaling.html](https://jsl.jmp.com/All%20Categories/Objects/Multidimensional%20Scaling.html)*
...
### [Multidimensional Scaling](#multidimensional-scaling_1)[](#multidimensional-scaling_1 "Click to copy url")
...
### [3D Plot](#3d-plot)[](#3d-plot "Click to copy url")

**Syntax:** obj \<\< "3D Plot"n( 1 )

**Description:** Shows or hides a 3-D plot, which requires a minimum of three dimensions.
...
### [Data Format](#data-format)[](#data-format "Click to copy url")

**Syntax:** Data Format( Distance Matrix \| Attribute List )

**Description:** Specifies the format of the data table, which can be a distance matrix or an attribute list.
...
**Description:** Reflects the multidimensional scaling plot on the horizontal axis.
...
**Description:** Reflects the multidimensional scaling plot on the vertical axis.
...
**Description:** Shows or hides the multidimensional scaling plot. On by default.
...
**Description:** Saves the dimension coordinates for the response variables to the data table.
...
### [Save Proximity](#save-proximity)[](#save-proximity "Click to copy url")

**Syntax:** obj \<\< Save Proximity

**Description:** Saves the proximity matrix to the data table. Available only when the data format is Attribute List.
...
### [Set Dimensions](#set-dimensions)[](#set-dimensions "Click to copy url")

**Syntax:** obj = Multidimensional Scaling(...Set Dimensions( number=2 )...)

**Description:** Specifies the dimensions for MDS. "2" by default.
...
### [Shepard Diagram](#shepard-diagram)[](#shepard-diagram "Click to copy url")

**Syntax:** obj \<\< Shepard Diagram( state=0\|1 )

**Description:** Shows or hides the Shepard diagram, which plots actual proximity versus predicted proximity. On by default.
...
**Description:** Shows or hides dimension coordinates for the response variables.
...
### [Show Proximity](#show-proximity)[](#show-proximity "Click to copy url")

**Syntax:** obj \<\< Show Proximity( state=0\|1 )

**Description:** Shows or hides a table of actual and predicted proximity values between response variables.
...
### [Transformation](#transformation)[](#transformation "Click to copy url")

**Syntax:** Transformation( None \| Ratio \| Interval \| Ordinal )

**Description:** Specifies the choice of transformation for the multidimensional scaling analysis.
...
### [Waern Links](#waern-links)[](#waern-links "Click to copy url")

**Syntax:** obj \<\< Waern Links( Smallest Portion \| Largest Portion, portion, visible )

**Description:** Specifies Waern links for the MDS plot. The first argument specifies whether links should be drawn for the smallest or largest portion. The second argument specifies the portion value. The third argument is a Boolean that specifies if the Waern link controls are visible.
...
[ Previous](Model%20Screening.html "Model Screening") [Next ](Multiple%20Correspondence%20Analysis.html "Multiple Correspondence Analysis")

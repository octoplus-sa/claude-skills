...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Normalization.html](https://jsl.jmp.com/All%20Categories/Objects/Normalization.html)*
...
### [Normalization](#normalization_1)[](#normalization_1 "Click to copy url")
...
### [X (Control) Columns](#x-control-columns)[](#x-control-columns "Click to copy url")

**Syntax:** obj \<\< X (Control) Columns( column(s) )
...
### [A Threshold](#a-threshold)[](#a-threshold "Click to copy url")

**Syntax:** Mean Expression Threshold ( number = 0.05 )

**Description:** Threshold for X Axis(A values) in MA Plot - TMM \| KDMM method "0.05" by default.
...
### [Create New Tables for Results](#create-new-tables-for-results)[](#create-new-tables-for-results "Click to copy url")
...
### [Interpolated Quantiles](#interpolated-quantiles)[](#interpolated-quantiles "Click to copy url")

**Syntax:** Interpolated Quantiles( state =0\|1 )

**Description:** Interpolated Quantiles for Determining Reference Column in TMM \| KDMM method
...
### [Log Transformed](#log-transformed)[](#log-transformed "Click to copy url")

**Syntax:** Log Transformation( state =0\|1 )

**Description:** Log Transformation of TMM \| KDMM Method
...
### [M Threshold](#m-threshold)[](#m-threshold "Click to copy url")

**Syntax:** Logratio Threshold ( number = 0.3 )

**Description:** Threshold for Y Axis(M values) in MA Plot - TMM \| KDMM method "0.3" by default.
...
**Syntax:** Method( "Row Standardize \| Relative Abundance Percentage (RAP) \| Relative Abundance Ratio (RAR) \| Centered Log Ratio (CLR) \| Count/Read Per Million (CPM/RPM) \| Read/Fragment Per Kilobase of Transcript Per Million Mapped Reads/Fragments (RPKM/FPKM) \| Transcript Per Million (TPM) \| Trimmed Mean of M-Values (TMM) \| Kernel Density Mean of M-Component (KDMM)" )
...
**Description:** Specifies that missing values in the data are imputed using a multivariate singular value decomposition (SVD) technique.
...
### [Prior Count](#prior-count)[](#prior-count "Click to copy url")

**Syntax:** Total Prior Count ( number = 0.25 )

**Description:** Prior Count for Applies to All Samples to Adjust Library Sizes - TMM \| KDMM method "0.25" by default.
...
### [Replace Y Data](#replace-y-data)[](#replace-y-data "Click to copy url")

**Syntax:** Replace Y Data( state =0\|1 )

**Description:** Specifies that data for the Y variables is replaced in the data table.
...
**Syntax:** obj = Normalization(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Normal%20Mixtures.html "Normal Mixtures") [Next ](Notebook.html "Notebook")

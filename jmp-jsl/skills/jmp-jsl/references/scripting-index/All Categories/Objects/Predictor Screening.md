...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Predictor%20Screening.html](https://jsl.jmp.com/All%20Categories/Objects/Predictor%20Screening.html)*
...
### [Predictor Screening](#predictor-screening_1)[](#predictor-screening_1 "Click to copy url")
...
**Syntax:** obj = Predictor Screening(...\<By( column(s) )\>...)
...
**Syntax:** obj = Predictor Screening(...Response( column(s) )...)
...
**Syntax:** obj = Predictor Screening(...X( column(s) )...)
...
**Syntax:** obj = Predictor Screening(...Y( column(s) )...)
...
### [Number Trees](#number-trees)[](#number-trees "Click to copy url")

**Syntax:** obj = Predictor Screening(...Number Trees( number=100 )...)

**Description:** Specifies the number of decision trees in the bootstrap forest model. "100" by default.
...
### [Save Results](#save-results)[](#save-results "Click to copy url")

**Syntax:** obj \<\< Save Results

**Description:** Creates a new data table that contains the predictor ranking table from the report.
...
**Syntax:** obj = Predictor Screening(...Set Random Seed( number )...)

**Description:** Sets the seed for the starting values that are used in the fitting procedures.
...
**Syntax:** obj = Predictor Screening(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](PictureBox.html "PictureBox") [Next ](Preferences.html "Preferences")

...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Repeated%20Measures%20Degradation.html](https://jsl.jmp.com/All%20Categories/Objects/Repeated%20Measures%20Degradation.html)*
...
### [Repeated Measures Degradation](#repeated-measures-degradation_1)[](#repeated-measures-degradation_1 "Click to copy url")
...
### [Bayesian Models](#bayesian-models)[](#bayesian-models "Click to copy url")

**Syntax:** obj \<\< Bayesian Models

**Description:** Specify Bayesian models.
...
**Description:** Specifies the transformation of the response, the transformation of time, and the model type.
...
### [Reference Temperature](#reference-temperature)[](#reference-temperature "Click to copy url")

**Syntax:** obj \<\< Reference Temperature

**Description:** Sets the reference temperature value used by appropriate models.
...
### [Reference X](#reference-x)[](#reference-x "Click to copy url")

**Syntax:** obj \<\< Reference X

**Description:** Sets the reference value used by appropriate models.
...
### [Save Posterior To Script](#save-posterior-to-script)[](#save-posterior-to-script "Click to copy url")

**Syntax:** obj \<\< Save Posterior To Script( state=0\|1 )

**Description:** Specifies that when you save the script for the current report, the script contains the posterior samples. If you run the saved script, the posterior samples are loaded directly from the script into the Repeated Measures Degradation analysis. On by default.
...
**Syntax:** obj = Repeated Measures Degradation(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Reliability%20Growth.html "Reliability Growth") [Next ](Response%20Screening.html "Response Screening")

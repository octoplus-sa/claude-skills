...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Ternary%20Plot.html](https://jsl.jmp.com/All%20Categories/Objects/Ternary%20Plot.html)*
...
### [Ternary Plot](#ternary-plot_1)[](#ternary-plot_1 "Click to copy url")
...
**Syntax:** obj = Ternary Plot(...\<By( column(s) )\>...)
...
### [Contour Formula](#contour-formula)[](#contour-formula "Click to copy url")

**Syntax:** obj = Ternary Plot(...Contour Formula( formula column )...)

**Description:** A formula column to create contours of the response surface.
...
### [Plotting](#plotting)[](#plotting "Click to copy url")

**Syntax:** obj = Ternary Plot(...Plotting( column(s) )...)

**Description:** Three or more columns representing mixture proportions.
...
**Syntax:** obj = Ternary Plot(...X( column(s) )...)
...
### [3D Graph](#3d-graph)[](#3d-graph "Click to copy url")

**Syntax:** obj \<\< 3D Graph( state=0\|1 )

**Description:** Displays a 3 dimensional graph using 4 or more X variables.
...
obj << Color Theme( "Spectral" );
```

### [Contour Fill](#contour-fill)[](#contour-fill "Click to copy url")

**Syntax:** obj \<\< Contour Fill( "Lines only"\|"Fill Above"\|"Fill Below" )

**Description:** Fills the defined contour in the Ternary Plot.
...
**Syntax:** obj \<\< Contour Value( \[c1, c2, c3, c4, c5\] )

**Description:** Changes the contours on the Ternary Plot.
...
**Description:** Show the shaded component constraints. On by default.
...
**Description:** Shows or hides the points on the Ternary Plot. On by default.
...
**Syntax:** obj = Ternary Plot(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Tabulate.html "Tabulate") [Next ](Text%20Explorer.html "Text Explorer")

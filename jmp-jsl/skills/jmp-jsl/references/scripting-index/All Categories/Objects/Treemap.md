...
*Source: [https://jsl.jmp.com/All%20Categories/Objects/Treemap.html](https://jsl.jmp.com/All%20Categories/Objects/Treemap.html)*
...
### [Treemap](#treemap_1)[](#treemap_1 "Click to copy url")

**Syntax:** Treemap( Categories( column ), \<Sizes( column )\>, \<Coloring( column )\> )

**Description:** Graph Builder alternative to creating a rectangular tiling for a nominal or ordinal variable. The tile categories are proportional in size to the counts of categories within a selected variable.
...
**Syntax:** obj \<\< Categories( column(s) )
...
### [Change Color Column](#change-color-column)[](#change-color-column "Click to copy url")

**Syntax:** obj \<\< Change Color Column( column )

**Description:** Changes the column used for coloring the categories.
...
### [Color Range](#color-range)[](#color-range "Click to copy url")

**Syntax:** obj \<\< Color Range( low, high )

**Description:** Sets the range for the color gradient. Default is low=min and high=max of the coloring column.
...
**Description:** Sets the color theme used for the treemap.
...
**Syntax:** obj = Treemap(...Layout( "Split"\|"Squarify"\|"Mixed" )...)

### [Legend](#legend)[](#legend "Click to copy url")

**Syntax:** obj \<\< Legend( state=0\|1 )

**Description:** Shows or hides a legend showing the values of the color column mapped to actual colors.
...
**Syntax:** obj = Treemap(...Window View( "Visible"\|"Invisible"\|"Private" )...)
...
[ Previous](Tree%20Node.html "Tree Node") [Next ](Triangulation.html "Triangulation")
